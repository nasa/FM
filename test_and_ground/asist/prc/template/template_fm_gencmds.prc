...
s get_tbl_to_cvt (ramDirPhys, freeSpaceTblName, "A", "$cpu_fmfreespacetbl",hostCPU,fsindex)
wait 5
...
s ftp_file ("CF:0/apps", FM_TABLE_FILENAME, FM_TABLE_FILENAME, hostCPU, "R")
wait 5
...
s load_table("$cpu_fmbadtbl_ld_1",hostCPU)
