PROC scx_cpu1_fm_specialchars1
;*******************************************************************************
...
;	scx_cpu1_fm_clearallpages	Removes all the FM pages from the screen
;	scx_cpu1_fm_dirfiledisplay	Issues the DirListFile command and 
;					performs the necessary actions to
;					display the contents in the page
;	scx_cpu1_fm_dirtlmdisplay	Issues the DirListTlm command
;	scx_cpu1_fm_startfmapps		Starts the FM and TST_FM applications
...
write ";*********************************************************************"
write ";  Step 2.1: Populate CPU1 with the required directories and files"
write ";*********************************************************************"
...
write ";*********************************************************************"
s ftp_file (downloadDir, "FMCAT1.TST", "actualfile.dat", hostCPU, "P")
wait 5

s ftp_file (downloadDir, testFileCompressed, testFileCompressed, hostCPU, "P")
wait 5
...
FOR testNameNum = 1 to totaltests DO
  ...
  ut_setupevents "SCX","CPU1",{FMAppName},FM_CREATE_DIR_SRC_ERR_EID, "ERROR", 3
  ...
  if (errcnt = SCX_CPU1_FM_CMDEC) then
    ...
    if (SCX_CPU1_find_event[2].num_found_messages = 1) THEN
      write "OS Error Event message ",SCX_CPU1_find_event[2].eventid," received"
    ...
    if (SCX_CPU1_find_event[3].num_found_messages = 1) then
      write "==> Source Dir Error Event message ",SCX_CPU1_find_event[3].eventid, " received."
    ...
    if (cmdctr = SCX_CPU1_FM_CMDPC) then
      ...
      if (SCX_CPU1_find_event[1].num_found_messages = 1) THEN
        write "<*> Passed (1003) - Event message ",SCX_CPU1_find_event[1].eventid, " received (Cmd received)"
        ut_setrequirements FM_1003, "P"
      else
  ...
  ut_setupevents "SCX","CPU1",{FMAppName},FM_GET_DIR_FILE_TGT_ERR_EID,"ERROR", 3
  ...
  if (validSpec = "No") then
    s scx_cpu1_fm_dirfiledisplay (testDestDir,testFileName,downloadDir,%name("testchar" & testNameNum),"Fail")
  else
    s scx_cpu1_fm_dirfiledisplay (testDestDir,testFileName2,testDownloadDir,%name("testchar" & testNameNum))
  endif
  ...
  if (errcnt = SCX_CPU1_FM_CMDEC) then
    ...
    if (SCX_CPU1_find_event[3].num_found_messages = 1) then
      write "==> Target File Error Event message ",SCX_CPU1_find_event[3].eventid," received"
  ...
  ut_setupevents "SCX", "CPU1", {FMAppName}, FM_CONCAT_OS_ERR_EID, "ERROR", 2
  ut_setupevents "SCX", "CPU1", {FMAppName}, FM_CONCAT_SRC1_ERR_EID, "ERROR", 3
  ...
  /SCX_CPU1_FM_FileCat File1=concatInFile File2=testFile DestName=concatOutFile1
  ...
  if (errcnt = SCX_CPU1_FM_CMDEC) then
    ...
    if (SCX_CPU1_find_event[3].num_found_messages = 1) then
      write "Source File1 Error Event message ", SCX_CPU1_find_event[3].eventid, " received."
  ...
  ut_setupevents "SCX", "CPU1", {FMAppName}, FM_CONCAT_CMD_EID, "DEBUG", 1
  ut_setupevents "SCX", "CPU1", {FMAppName}, FM_CONCAT_OS_ERR_EID, "ERROR", 2
  ut_setupevents "SCX", "CPU1", {FMAppName}, FM_CONCAT_SRC2_ERR_EID, "ERROR", 3
  ...
  /SCX_CPU1_FM_FileCat File1=testFile File2=concatInFile DestName=concatOutFile2
  ...
  if (errcnt = SCX_CPU1_FM_CMDEC) then
    ...
    if (SCX_CPU1_find_event[3].num_found_messages = 1) then
      write "Source File2 Error Event message ", SCX_CPU1_find_event[3].eventid, " received."
  ...
  ut_setupevents "SCX", "CPU1", {FMAppName}, FM_CONCAT_CMD_EID, "DEBUG", 1
  ut_setupevents "SCX", "CPU1", {FMAppName}, FM_CONCAT_OS_ERR_EID, "ERROR", 2
  ut_setupevents "SCX", "CPU1", {FMAppName}, FM_CONCAT_TGT_ERR_EID, "ERROR", 3
  ...
  /SCX_CPU1_FM_FileCat File1=testFile File2=testFile DestName=testFileName
  ...
  if (errcnt = SCX_CPU1_FM_CMDEC) then
    ...
    if (SCX_CPU1_find_event[3].num_found_messages = 1) then
      write "Destination File Error Event message ", SCX_CPU1_find_event[3].eventid, " received."
  ...
  ut_setupevents "SCX", "CPU1", {FMAppName}, FM_COPY_CMD_EID, "DEBUG", 1
  ut_setupevents "SCX", "CPU1", {FMAppName}, FM_COPY_OS_ERR_EID, "ERROR", 2
  ut_setupevents "SCX", "CPU1", {FMAppName}, FM_COPY_SRC_ERR_EID, "ERROR", 3
  ...
  /SCX_CPU1_FM_FileCopy Overwrite=0 File=testFileName DestName=copyOutFile
  ...
  if (errcnt = SCX_CPU1_FM_CMDEC) then
    ...
    if (SCX_CPU1_find_event[3].num_found_messages = 1) then
      write "Source File Error Event message ", SCX_CPU1_find_event[3].eventid, " received."
  ...
  ;; Delete File Command
  ut_setupevents "SCX", "CPU1", {FMAppName}, FM_DELETE_CMD_EID, "DEBUG", 1
  ut_setupevents "SCX", "CPU1", {FMAppName}, FM_DELETE_OS_ERR_EID, "ERROR", 2
  ut_setupevents "SCX", "CPU1", {FMAppName}, FM_DELETE_SRC_ERR_EID, "ERROR", 3
  ...
  /SCX_CPU1_FM_Delete File=testFileName
  ...
  ut_setupevents "SCX", "CPU1", {FMAppName}, FM_COPY_CMD_EID, "DEBUG", 1
  ut_setupevents "SCX", "CPU1", {FMAppName}, FM_COPY_OS_ERR_EID, "ERROR", 2
  ut_setupevents "SCX", "CPU1", {FMAppName}, FM_COPY_TGT_ERR_EID, "ERROR", 3
  ...
  /SCX_CPU1_FM_FileCopy Overwrite=0 File=fullCompressedFileSpec DestName=testFileName
  ...
  ut_setupevents "SCX", "CPU1", {FMAppName}, FM_DECOM_CMD_EID, "DEBUG", 1
  ut_setupevents "SCX", "CPU1", {FMAppName}, FM_DECOM_CFE_ERR_EID, "ERROR", 2
  ut_setupevents "SCX", "CPU1", {FMAppName}, FM_DECOM_SRC_ERR_EID, "ERROR", 3
  ...
  /SCX_CPU1_FM_Decompress File=testFileName DestName=decomOutFile
  ...
  ut_setupevents "SCX", "CPU1", {FMAppName}, FM_DECOM_CMD_EID, "DEBUG", 1
  ut_setupevents "SCX", "CPU1", {FMAppName}, FM_DECOM_CFE_ERR_EID, "ERROR", 2
  ut_setupevents "SCX", "CPU1", {FMAppName}, FM_DECOM_TGT_ERR_EID, "ERROR", 3
  ...
  /SCX_CPU1_FM_Decompress DestName=testFileName File=fullCompressedFileSpec 
  ...
  ut_setupevents "SCX","CPU1",{FMAppName},FM_GET_FILE_INFO_SRC_ERR_EID,"ERROR",2
  ...
  if (validSpec = "Yes") then
    s scx_cpu1_fm_fileinfodisplay (testFileName)
  else
    s scx_cpu1_fm_fileinfodisplay (testFileName,0,"Fail")
  endif
  ...
  if (errcnt = SCX_CPU1_FM_CMDEC) then
    ...
    if (SCX_CPU1_find_event[2].num_found_messages = 1) THEN
      write "==> File Error Event message ", SCX_CPU1_find_event[2].eventid, " received."
  ...
  ut_setupevents "SCX", "CPU1", {FMAppName}, FM_MOVE_CMD_EID, "DEBUG", 1
  ut_setupevents "SCX", "CPU1", {FMAppName}, FM_MOVE_OS_ERR_EID, "ERROR", 2
  ut_setupevents "SCX", "CPU1", {FMAppName}, FM_MOVE_SRC_ERR_EID, "ERROR", 3
  ...
  /SCX_CPU1_FM_FileMove Overwrite=0 File=testFileName DestName=moveOutFile
  ...
  if (errcnt = SCX_CPU1_FM_CMDEC) then
    ...
    if (SCX_CPU1_find_event[3].num_found_messages = 1) THEN
      write "==> File Error Event message ", SCX_CPU1_find_event[3].eventid, " received."
  ...
  ut_setupevents "SCX", "CPU1", {FMAppName}, FM_MOVE_CMD_EID, "DEBUG", 1
  ut_setupevents "SCX", "CPU1", {FMAppName}, FM_MOVE_OS_ERR_EID, "ERROR", 2
  ut_setupevents "SCX", "CPU1", {FMAppName}, FM_MOVE_TGT_ERR_EID, "ERROR", 3
  ...
  if (validSpec = "Yes") then
    /SCX_CPU1_FM_FileMove Overwrite=0 DestName=testFileName File=moveOutFile
  else
    /SCX_CPU1_FM_FileMove Overwrite=0 DestName=testFileName File=testFile
  endif
  ...
  ut_setupevents "SCX", "CPU1", {FMAppName}, FM_RENAME_CMD_EID, "DEBUG", 1
  ut_setupevents "SCX", "CPU1", {FMAppName}, FM_RENAME_OS_ERR_EID, "ERROR", 2
  ut_setupevents "SCX", "CPU1", {FMAppName}, FM_RENAME_SRC_ERR_EID, "ERROR", 3
  ...
  /SCX_CPU1_FM_FileRename File=testFileName DestName=renameOutFile
  ...
  ut_setupevents "SCX", "CPU1", {FMAppName}, FM_RENAME_CMD_EID, "DEBUG", 1
  ut_setupevents "SCX", "CPU1", {FMAppName}, FM_RENAME_OS_ERR_EID, "ERROR", 2
  ut_setupevents "SCX", "CPU1", {FMAppName}, FM_RENAME_TGT_ERR_EID, "ERROR", 3
  ...
  if (validSpec = "Yes") then
    /SCX_CPU1_FM_FileRename DestName=testFileName File=renameOutFile
  else
    /SCX_CPU1_FM_FileRename DestName=testFileName File=testFile
  endif
  ...
  ut_setupevents "SCX","CPU1",{FMAppName},FM_GET_DIR_PKT_OS_ERR_EID, "ERROR", 2
  ut_setupevents "SCX","CPU1",{FMAppName},FM_GET_DIR_PKT_SRC_ERR_EID,"ERROR", 3
  ...
  if (validSpec = "No") then
    s scx_cpu1_fm_dirtlmdisplay (testDirName, 0, "Fail")
  else
  ...
  ut_setupevents "SCX","CPU1",{FMAppName},FM_GET_DIR_FILE_CMD_EID, "DEBUG", 1
  ut_setupevents "SCX","CPU1",{FMAppName},FM_GET_DIR_FILE_OS_ERR_EID, "ERROR", 2
  ut_setupevents "SCX","CPU1",{FMAppName},FM_GET_DIR_FILE_SRC_ERR_EID,"ERROR", 3
  ...
  if (validSpec = "Yes") then
    ...
    s scx_cpu1_fm_dirfiledisplay (testDirName, fullDirListOutFile, testDownloadDir, dirListOutFile)
  else
    fullDirListOutFile = testDestDir & forwardSlash & dirListOutFile
    s scx_cpu1_fm_dirfiledisplay (testDirName, fullDirListOutFile, downloadDir, dirListOutFile, "Fail")
  endif
  ...
  if (errcnt = SCX_CPU1_FM_CMDEC) then
    ...
    if (SCX_CPU1_find_event[3].num_found_messages = 1) then
      write "==> Src Dir Error Event message ",SCX_CPU1_find_event[3].eventid," received"
    ...
    if (cmdctr = SCX_CPU1_FM_CMDPC) then
      ...
      if (SCX_CPU1_find_event[1].num_found_messages = 1) THEN
        write "<*> Passed (1003;3002.1) - Event message ",SCX_CPU1_find_event[1].eventid, " received (Cmd received)"
        ut_setrequirements FM_1003, "P"
        ut_setrequirements FM_3002_1, "P"
      else
  ...
  ut_setupevents "SCX","CPU1",{FMAppName},FM_DELETE_ALL_OS_ERR_EID, "ERROR", 2
  ut_setupevents "SCX","CPU1",{FMAppName},FM_DELETE_ALL_SRC_ERR_EID,"ERROR", 3
  ...
  /SCX_CPU1_FM_DeleteAll DirName=testDirName
  ...
  ut_setupevents "SCX","CPU1",{FMAppName}, FM_DELETE_DIR_OS_ERR_EID, "ERROR", 2
  ut_setupevents "SCX","CPU1",{FMAppName}, FM_DELETE_DIR_SRC_ERR_EID,"ERROR", 3
  ...
  /SCX_CPU1_FM_DirDelete DirName=testDirName
  ...
  if (errcnt = SCX_CPU1_FM_CMDEC) then
    ...
    if (SCX_CPU1_find_event[3].num_found_messages = 1) then
      write "==> Source Dir Event message ", SCX_CPU1_find_event[3].eventid, " received."
...
write ""
write ";*********************************************************************"
write ";  End procedure scx_cpu1_fm_specialchars1                            "
write ";*********************************************************************"
ENDPROC
