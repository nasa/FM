PROC scx_cpu1_fm_specialchars4
;*******************************************************************************
...
FOR testNameNum = 1 to totaltests DO
  ...
  if (validSpec = "No") then
    s scx_cpu1_fm_dirfiledisplay (testDestDir,testFileName,downloadDir,testFileNameOnly,"Fail")
  else
    s scx_cpu1_fm_dirfiledisplay (testDestDir,testFileName2,testDownloadDir,testFileNameOnly)
  endif
...
write ""
write ";*********************************************************************"
write ";  End procedure scx_cpu1_fm_specialchars4                            "
write ";*********************************************************************"
ENDPROC
