PROC scx_cpu1_fm_filedelete_stress
;*******************************************************************************
...
write ";*********************************************************************"
ut_setupevents "SCX", "CPU1", {FMAppName}, FM_DELETE_PKT_ERR_EID, "ERROR", 1
...
if (SCX_CPU1_FM_CMDEC = errcnt) then
  ...
  if (SCX_CPU1_find_event[1].num_found_messages = 1) THEN
    ...
    write "<!> Failed (1004) - Event message ",SCX_CPU1_evs_eventid," received. Expected Event message ", FM_DELETE_PKT_ERR_EID, "."
...
write ";*********************************************************************"
ut_setupevents "SCX", "CPU1", {FMAppName}, FM_DELETE_SRC_DNE_ERR_EID, "ERROR", 1

cmdctr = SCX_CPU1_FM_CMDPC + 1
errcnt = SCX_CPU1_FM_CMDEC + 1

/SCX_CPU1_FM_Delete File=badPath
...
if (SCX_CPU1_FM_CMDEC = errcnt) then
  ...
  if (SCX_CPU1_find_event[1].num_found_messages = 1) THEN
    ...
    write "<!> Failed (1004) - Event message ",SCX_CPU1_evs_eventid," received. Expected Event message ", FM_DELETE_SRC_DNE_ERR_EID, "."
    ut_setrequirements FM_1004, "F"
  endif
else
...
write ";*********************************************************************"
ut_setupevents "SCX", "CPU1", {FMAppName}, FM_DELETE_SRC_ISDIR_ERR_EID, "ERROR", 1

cmdctr = SCX_CPU1_FM_CMDPC + 1
errcnt = SCX_CPU1_FM_CMDEC + 1

/SCX_CPU1_FM_Delete File=testSourceDir & forwardSlash & ""
...
if ( SCX_CPU1_FM_CMDEC = errcnt) then
  ...
  if (SCX_CPU1_find_event[1].num_found_messages = 1) THEN
    ...
    write "<!> Failed (1004) - Event message ",SCX_CPU1_evs_eventid," received. Expected Event message ", FM_DELETE_SRC_ISDIR_ERR_EID, "."
    ut_setrequirements FM_1004, "F"
  endif
else  
...
s scx_cpu1_fm_fileinfodisplay (testSourceDir)
...
if (SCX_CPU1_FM_CMDPC = cmdctr) then
  ...
  if (p@SCX_CPU1_FM_FileStatus = "Directory") THEN
...
/SCX_CPU1_FM_Delete File=testSourceDir & forwardSlash & "nonexist.tst"
...
write ";*********************************************************************"
ut_setupevents "SCX", "CPU1", {FMAppName}, FM_DELETE_SRC_INVALID_ERR_EID,  "ERROR", 1

cmdctr = SCX_CPU1_FM_CMDPC + 1
errcnt = SCX_CPU1_FM_CMDEC + 1

/SCX_CPU1_FM_Delete File=""
...
if (SCX_CPU1_FM_CMDEC = errcnt) then
  ...
  if (SCX_CPU1_find_event[1].num_found_messages = 1) THEN
    ...
    write "<!> Failed (1004) - Event message ",SCX_CPU1_evs_eventid," received. Expected Event message ", FM_DELETE_SRC_INVALID_ERR_EID, "."
    ut_setrequirements FM_1004, "F"
  endif
else
...
/SCX_CPU1_FM_Delete File=fullTestLongName1
...
/SCX_CPU1_FM_Delete File=fullTestLongName2
...
/SCX_CPU1_FM_Delete File=fullTestLongName3
...
/SCX_CPU1_FM_Delete File=fullTestShortName
...
s ftp_file (ramDirPhys, testFile, testFile, hostCPU, "P")

ut_setupevents "SCX", "CPU1", "TST_FM", TST_FM_DELETEFILE_INF_EID, "INFO", 1
ut_setupevents "SCX", "CPU1", {FMAppName}, FM_DELETE_CMD_EID, "DEBUG", 2

cmdctr = SCX_CPU1_TST_FM_CMDPC + 1

/SCX_CPU1_TST_FM_Delete File=ramDir & forwardSlash & testFile
...
if (UT_TW_Status = UT_Success) then
  ...
  write "<!> Failed - Event message ", SCX_CPU1_evs_eventid," received. Expected Event message ", TST_FM_DELETEFILE_INF_EID, "."
endif

wait 5

;; Verify that the FM Delete File event message did not get generated
if (SCX_CPU1_find_event[2].num_found_messages = 0) then
...
write ";*********************************************************************"
ut_setupevents "SCX", "CPU1", {FMAppName}, FM_DELETE_ALL_PKT_ERR_EID, "ERROR", 1
...
if (SCX_CPU1_FM_CMDEC = errcnt) then
  ...
  if (SCX_CPU1_find_event[1].num_found_messages = 1) THEN
    ...
    write "<!> Failed (1004) - Event message ", SCX_CPU1_evs_eventid," received. Expected Event message ", FM_DELETE_ALL_PKT_ERR_EID, "."
    ut_setrequirements FM_1004, "F"
  endif
else
  write "<!> Failed (1002;1004) - Command Rejected Counter did not increment as expected."
...
write ";*********************************************************************"
ut_setupevents "SCX", "CPU1", {FMAppName}, FM_DELETE_ALL_SRC_DNE_ERR_EID, "ERROR", 1

cmdctr = SCX_CPU1_FM_CMDPC + 1
errcnt = SCX_CPU1_FM_CMDEC + 1

/SCX_CPU1_FM_DeleteAll DirName=ramDir & "/imaginary/"
...
if ( SCX_CPU1_FM_CMDEC = errcnt ) then
  ...
  if (SCX_CPU1_find_event[1].num_found_messages = 1) THEN
    ...
    write "<!> Failed (1004) - Event message ", SCX_CPU1_evs_eventid," received. Expected Event message ", FM_DELETE_ALL_SRC_DNE_ERR_EID, "."
    ut_setrequirements FM_1004, "F"
  endif
else
...
write ";*********************************************************************"
ut_setupevents "SCX", "CPU1", {FMAppName}, FM_DELETE_ALL_SRC_INVALID_ERR_EID, "ERROR", 1

cmdctr = SCX_CPU1_FM_CMDPC + 1
errcnt = SCX_CPU1_FM_CMDEC + 1

/SCX_CPU1_FM_DeleteAll DirName=""
...
if ( SCX_CPU1_FM_CMDEC = errcnt ) then
  ...
  if (SCX_CPU1_find_event[1].num_found_messages = 1) THEN
    ...
    write "<!> Failed (1004) - Event message ", SCX_CPU1_evs_eventid," received. Expected Event message ", FM_DELETE_ALL_SRC_INVALID_ERR_EID, "."
    ut_setrequirements FM_1004, "F"
  endif
else
...
s ftp_file (uploadDir2, testFile, testFile, hostCPU,"P")
...
/SCX_CPU1_FM_DeleteAll DirName=longDirName1
...
if (SCX_CPU1_FM_CMDPC = cmdctr) then
  ...
  if (SCX_CPU1_find_event[1].num_found_messages = 1) THEN
    ...
    write "<!> Failed (1003) - Event message ", SCX_CPU1_evs_eventid," received. Expected Event message ", FM_DELETE_ALL_CMD_EID, "."
    ut_setrequirements FM_1003, "F"
  endif
...
s scx_cpu1_fm_dirfiledisplay (longDirName1, ramDir & "/fm_delstress_5.lst", ramDirPhys, "fm_delstress_5.lst")
...
s scx_cpu1_fm_dirfiledisplay (testDirName, "/ram/fm_delstress_6.lst", "RAM:0", "fm_delstress_6.lst")
...
s scx_cpu1_fm_dirfiledisplay (testDirName, "/ram/fm_delstress_7.lst", "RAM:0", "fm_delstress_7.lst")
...
write ";*********************************************************************"
s scx_cpu1_fm_dirfiledisplay (ramDir, ramDir & "/fm_delstress_8.lst", ramDirPhys, "fm_delstress_8.lst")
...
/SCX_CPU1_FM_DeleteAll DirName=ramDir
...
s scx_cpu1_fm_dirfiledisplay (ramDir, ramDir & "/fm_delstress_9.lst", ramDirPhys, "fm_delstress_9.lst")
...
/SCX_CPU1_FM_DirCreate DirName=ramDir & "/emptydir"
...
s scx_cpu1_fm_dirfiledisplay (ramDir, ramDir & "/fm_delstress_10.lst", ramDir, "fm_delstress_10.lst")
write "<**> Check the contents of ", ramDir, " for the directory /emptydir"

ut_setupevents "SCX", "CPU1", {FMAppName}, FM_DELETE_ALL_CMD_EID, "DEBUG", 1
ut_setupevents "SCX", "CPU1", {FMAppName}, FM_DELETE_ALL_SKIP_WARNING_EID, "INFO", 2
...
if (SCX_CPU1_FM_CMDPC = cmdctr) then
  ...
  if (SCX_CPU1_find_event[2].num_found_messages = 1) THEN
    write "<*> Passed (2007.2.1) - Event message ", SCX_CPU1_find_event[2].eventid, " received"
    ut_setrequirements FM_200721, "P"
  else
    write "<!> Failed (2007.2.1) - Event message ", SCX_CPU1_evs_eventid," received. Expected Event message ", FM_DELETE_ALL_SKIP_WARNING_EID, "."
...
s scx_cpu1_fm_fileinfodisplay (ramDir & "/emptydir")
...
s scx_cpu1_fm_dirfiledisplay (ramDir, ramDir & "/fm_delstress_11.lst", ramDir, "fm_delstress_11.lst")
...
write ";*********************************************************************"
write ";  End procedure scx_cpu1_fm_filedelete_stress                        "
write ";*********************************************************************"
ENDPROC
