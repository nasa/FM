PROC scx_cpu1_fm_specialchars5
;*******************************************************************************
...
FOR testNameNum = 1 to totaltests DO
  ...
  if (validSpec = "No") then
    ...
    s scx_cpu1_fm_dirfiledisplay (testDestDir,testFileName,downloadDir,testFileNameOnly)
  endif
  ...
  /scx_cpu1_FM_FileCat File1=testFileName File2=testFile DestName=concatOutFile1
  ...
  /scx_cpu1_FM_FileCat File1=testFile File2=testFileName DestName=concatOutFile2
...
write ""
write ";*********************************************************************"
write ";  End procedure scx_cpu1_fm_specialchars5                            "
write ";*********************************************************************"
ENDPROC
