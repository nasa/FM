PROC scx_cpu1_fm_tableloadfile
;*******************************************************************************
...
SCX_CPU1_FM_FreeSpaceTBL[0].Name = ramDir
...
s create_tbl_file_from_cvt (hostCPU,tblAppId,"FM FreeSpace Table Load 1","cpu1_fmdevtbl_ld_1",freeSpaceTblName,"SCX_CPU1_FM_FreeSpaceTBL[0].State",endmnemonic)
