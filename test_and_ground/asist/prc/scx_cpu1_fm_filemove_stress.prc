PROC scx_cpu1_fm_filemove_stress
;*******************************************************************************
...
write ";*********************************************************************"
ut_setupevents "SCX", "CPU1", {FMAppName}, FM_MOVE_PKT_ERR_EID, "ERROR", 1
...
if (SCX_CPU1_FM_CMDEC = errcnt) then
  ...
  if (SCX_CPU1_find_event[1].num_found_messages = 1) THEN
    ...
    write "<!> Failed (1004) - Event message ",SCX_CPU1_evs_eventid," received. Expected Event message ",FM_MOVE_PKT_ERR_EID
...
write ";*********************************************************************"
ut_setupevents "SCX", "CPU1", {FMAppName}, FM_MOVE_OS_ERR_EID, "ERROR", 1

cmdctr = SCX_CPU1_FM_CMDPC + 1
errcnt = SCX_CPU1_FM_CHILDCMDEC + 1

/SCX_CPU1_FM_FileMove Overwrite=0 DestName=badPath File=fullOriginalTestFileName
...
if (UT_TW_Status = UT_Success) then
  ...
  if (SCX_CPU1_find_event[1].num_found_messages = 1) THEN
    ...
    write "<!> Failed (1004) - Event message ",SCX_CPU1_evs_eventid," received. Expected Event message ",FM_MOVE_OS_ERR_EID
    ut_setrequirements FM_1004, "F"
  endif
else
...
write ";*********************************************************************"
ut_setupevents "SCX", "CPU1", {FMAppName}, FM_MOVE_TGT_ISDIR_ERR_EID, "ERROR", 1

cmdctr = SCX_CPU1_FM_CMDPC + 1
errcnt = SCX_CPU1_FM_CMDEC + 1

/SCX_CPU1_FM_FileMove Overwrite=0 DestName=testDestDir & forwardSlash & "" File=fullOriginalTestFileName
...
if ( SCX_CPU1_FM_CMDEC = errcnt ) then
  ...
  if (SCX_CPU1_find_event[1].num_found_messages = 1) THEN
    ...
    write "<!> Failed (1004) - Event message ",SCX_CPU1_evs_eventid," received. Expected Event message ",FM_MOVE_TGT_ISDIR_ERR_EID
    ut_setrequirements FM_1004, "F"
  endif
else
  write "<!> Failed (1004;1005;2004) - Command Rejected Counter did not increment as expected."
...
write ";*********************************************************************"
ut_setupevents "SCX", "CPU1", {FMAppName}, FM_MOVE_SRC_DNE_ERR_EID, "ERROR", 1

cmdctr = SCX_CPU1_FM_CMDPC + 1
errcnt = SCX_CPU1_FM_CMDEC + 1

/SCX_CPU1_FM_FileMove Overwrite=0 File=badPath DestName=testDestDir & "/invalidSrcPath.tst"
...
if (SCX_CPU1_FM_CMDEC = errcnt) then
  ...
  if (SCX_CPU1_find_event[1].num_found_messages = 1) THEN
    ...
    write "<!> Failed (1004) - Event message ",SCX_CPU1_evs_eventid," received. Expected Event message ",FM_MOVE_SRC_DNE_ERR_EID
    ut_setrequirements FM_1004, "F"
  endif
else
  write "<!> Failed (1004;1005;2004) - Command Rejected Counter did not increment as expected."
...
write ";*********************************************************************"
ut_setupevents "SCX", "CPU1", {FMAppName}, FM_MOVE_SRC_ISDIR_ERR_EID, "ERROR", 1

cmdctr = SCX_CPU1_FM_CMDPC + 1
errcnt = SCX_CPU1_FM_CMDEC + 1

/SCX_CPU1_FM_FileMove Overwrite=0 File=testSourceDir & forwardSlash & "" DestName=testDestDir & "/invalidSrcName.tst"
...
if (SCX_CPU1_FM_CMDEC = errcnt) then
  ...
  if (SCX_CPU1_find_event[1].num_found_messages = 1) THEN
    ...
    write "<!> Failed (1004) - Event message ",SCX_CPU1_evs_eventid," received. Expected Event message ",FM_MOVE_SRC_ISDIR_ERR_EID
    ut_setrequirements FM_1004, "F"
  endif
else  
...
write ";*********************************************************************"
ut_setupevents "SCX", "CPU1", {FMAppName}, FM_MOVE_TGT_EXIST_ERR_EID, "ERROR", 1

cmdctr = SCX_CPU1_FM_CMDPC + 1
errcnt = SCX_CPU1_FM_CMDEC + 1

/SCX_CPU1_FM_FileMove Overwrite=0 File=fullOriginalTestFileName DestName=fullOriginalTestFileName
...
if (SCX_CPU1_FM_CMDEC = errcnt) then
  ...
  if (SCX_CPU1_find_event[1].num_found_messages = 1) THEN
    ...
    write "<!> Failed (1004) - Event message ",SCX_CPU1_evs_eventid," received. Expected Event message ",FM_MOVE_TGT_EXIST_ERR_EID
    ut_setrequirements FM_1004, "F"
  endif
else
...
write ";*********************************************************************"
ut_setupevents "SCX", "CPU1", {FMAppName}, FM_MOVE_SRC_INVALID_ERR_EID, "ERROR", 1

cmdctr = SCX_CPU1_FM_CMDPC + 1
errcnt = SCX_CPU1_FM_CMDEC + 1

/SCX_CPU1_FM_FileMove Overwrite=0 File="" DestName=testDestDir & "/LONGTEST_1.TST"
...
if (SCX_CPU1_FM_CMDEC = errcnt) then
  ...
  if (SCX_CPU1_find_event[1].num_found_messages = 1) THEN
    ...
    write "<!> Failed (1004) - Event message ",SCX_CPU1_evs_eventid," received. Expected Event message ",FM_MOVE_SRC_INVALID_ERR_EID
    ut_setrequirements FM_1004, "F"
  endif
else
...
/SCX_CPU1_FM_FileMove Overwrite=0 File=fullTestLongName1 DestName=testDestDir & "/LONGTEST_1.TST"
...
if (SCX_CPU1_FM_CMDPC = cmdctr) then
  ...
  if (SCX_CPU1_find_event[1].num_found_messages = 1) THEN
    ...
    write "<!> Failed (1003) - Event message ",SCX_CPU1_evs_eventid," received. Expected Event message ", FM_MOVE_CMD_EID, "."
    ut_setrequirements FM_1003, "F"
  endif
else
...
s scx_cpu1_fm_fileinfodisplay (testDestDir & "/LONGTEST_1.TST")
...
/SCX_CPU1_FM_FileMove Overwrite=0 File=fullTestLongName2 DestName=testDestDir & "/LONGTEST_2.TST"
...
s scx_cpu1_fm_fileinfodisplay (testDestDir & "/LONGTEST_2.TST")
...
/SCX_CPU1_FM_FileMove Overwrite=0 File=fullTestLongName3 DestName=testDestDir & "/LONGTEST_3.TST"
...
s scx_cpu1_fm_fileinfodisplay (testDestDir & "/LONGTEST_3.TST")
...
/SCX_CPU1_FM_FileMove Overwrite=0 File=fullTestShortName DestName=testDestDir & "/SHORTEST.TST"
...
ut_setupevents "SCX", "CPU1", {FMAppName}, FM_MOVE_TGT_INVALID_ERR_EID, "ERROR", 1

cmdctr = SCX_CPU1_FM_CMDPC + 1
errcnt = SCX_CPU1_FM_CMDEC + 1

/SCX_CPU1_FM_FileMove Overwrite=0 File=fullOriginalTestFileName DestName=""
...
if (SCX_CPU1_FM_CMDEC = errcnt) then
  ...
  if (SCX_CPU1_find_event[1].num_found_messages = 1) THEN
    ...
    write "<!> Failed (1004) - Event message ", SCX_CPU1_evs_eventid," received. Expected Event message ", FM_MOVE_TGT_INVALID_ERR_EID, "."
    ut_setrequirements FM_1004, "F"
  endif
else
  write "<!> Failed (1004;1005;2004) - Command Accepted zero character file name!"
...
/SCX_CPU1_FM_FileMove Overwrite=0 File=fullOriginalTestFileName DestName=longDirName1 & "/FMLONG1.TST"
...
/SCX_CPU1_FM_FileMove Overwrite=0 File=fullOriginalTestFileName DestName=longDirName2 & "/FMLONG2.TST"
...
/SCX_CPU1_FM_FileMove Overwrite=0 File=fullOriginalTestFileName DestName=longDirName3 & "/FMLONG3.TST"
...
/SCX_CPU1_FM_FileMove Overwrite=0 File=fullOriginalTestFileName DestName=ramDir & "/B"
...
/SCX_CPU1_FM_FileMove Overwrite=0 File=fullTestFileName1 DestName=testDestDir & "/FMZEROLEN1.TST"
...
/SCX_CPU1_FM_FileMove Overwrite=0 File=fullTestFileName2 DestName=testDestDir & "/FMLARGE1.TST"
...
/SCX_CPU1_FM_FileMove Overwrite=0 File=fullOriginalTestFileName DestName=testDestDir2 & forwardSlash & testFile

ut_tlmwait SCX_CPU1_FM_CHILDCMDPC, {cmdctr}
if (UT_TW_Status = UT_Success) then
  write "<*> Passed (2004) - Move Command Accepted."
  ut_setrequirements FM_2004, "P"
...
write ";*********************************************************************"
write ";  End procedure scx_cpu1_fm_filemove_stress                          "
write ";*********************************************************************"
ENDPROC
