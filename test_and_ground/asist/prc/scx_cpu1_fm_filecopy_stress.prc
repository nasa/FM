PROC scx_cpu1_fm_filecopy_stress
;*******************************************************************************
...
write ";*********************************************************************"
ut_setupevents "SCX", "CPU1", {FMAppName}, FM_COPY_PKT_ERR_EID, "ERROR", 1
...
if ( SCX_CPU1_FM_CMDEC = errcnt ) then
  ...
  if (SCX_CPU1_find_event[1].num_found_messages = 1) THEN
    ...
    write "<!> Failed (1004) - Event message ", SCX_CPU1_evs_eventid," received. Expected Event message ",FM_COPY_PKT_ERR_EID, "."
...
/scx_cpu1_FM_FileCopy Overwrite=0 DestName=badPath File=fullOriginalTestFileName
...
if (SCX_CPU1_FM_CHILDCMDEC = errcnt) then
  ...
  if (SCX_CPU1_find_event[1].num_found_messages = 1) THEN
    ...
    write "<!> Failed (1004) - Event message ", SCX_CPU1_evs_eventid," received. Expected Event message ",FM_COPY_OS_ERR_EID, "."
  endif
else
...
write ";*********************************************************************"
ut_setupevents "SCX", "CPU1", {FMAppName}, FM_COPY_SRC_DNE_ERR_EID, "ERROR", 1

cmdctr = SCX_CPU1_FM_CMDPC + 1
errcnt = SCX_CPU1_FM_CMDEC + 1

/scx_cpu1_FM_FileCopy Overwrite=0 File=badPath DestName=testDestDir & "/invalidSrcPath.tst"
...
if (SCX_CPU1_FM_CMDEC = errcnt) then
  ...
  if (SCX_CPU1_find_event[1].num_found_messages = 1) THEN
    ...
    write "<!> Failed (1004) - Event message ", SCX_CPU1_evs_eventid," received. Expected Event message ",FM_COPY_SRC_DNE_ERR_EID, "."
  endif
else
  write "<!> Failed (1004;1005) - Command Rejected Counter did not increment as expected."
  ut_setrequirements FM_1004, "F"
...
s scx_cpu1_fm_fileinfodisplay (testDestDir & "/invalidSrcPath.tst")
...
if (SCX_CPU1_FM_CMDPC = cmdctr) then
  ...
  if (SCX_CPU1_find_event[1].num_found_messages = 1) THEN
    ...
    write "<!> Failed (1003) - Event message ", SCX_CPU1_evs_eventid," received. Expected Event message ",FM_GET_FILE_INFO_CMD_EID, "."
  endif

  if (p@SCX_CPU1_FM_FileStatus = "Not Used") THEN
    write "<*> Passed - File status indicates that the file does not exist."
  else
    write "<!> Failed - Expected file status 'Not Used'. Rcv'd '", p@SCX_CPU1_FM_FileStatus, "'"
  endif
else
...
write ";*********************************************************************"
ut_setupevents "SCX", "CPU1", {FMAppName}, FM_COPY_SRC_ISDIR_ERR_EID, "ERROR", 1

errcnt = SCX_CPU1_FM_CMDEC + 1

/scx_cpu1_FM_FileCopy Overwrite=0 File=testSourceDir & forwardSlash & "" DestName=testDestDir & "/SrcDirOnly.tst"

ut_tlmwait SCX_CPU1_FM_CMDEC, {errcnt}
if (UT_TW_Status = UT_Success) then
  ...
  if (SCX_CPU1_find_event[1].num_found_messages = 1) THEN
    ...
    write "<!> Failed (1004) - Event message ", SCX_CPU1_evs_eventid," received. Expected Event message ",FM_COPY_SRC_ISDIR_ERR_EID, "."
    ut_setrequirements FM_1004, "F"
  endif
else  
...
s scx_cpu1_fm_fileinfodisplay (testDestDir & "/SrcDirOnly.tst")
...
write ";*********************************************************************"
ut_setupevents "SCX", "CPU1", {FMAppName}, FM_COPY_TGT_EXIST_ERR_EID, "ERROR", 1

errcnt = SCX_CPU1_FM_CMDEC + 1

/scx_cpu1_FM_FileCopy Overwrite=0 File=fullOriginalTestFileName DestName=fullOriginalTestFileName
...
if ( SCX_CPU1_FM_CMDEC = errcnt ) then
  ...
  if (SCX_CPU1_find_event[1].num_found_messages = 1) THEN
    ...
    write "<!> Failed (1004) - Event message ", SCX_CPU1_evs_eventid," received. Expected Event message ",FM_COPY_TGT_EXIST_ERR_EID, "."
    ut_setrequirements FM_1004, "F"
  endif
else
...
write ";*********************************************************************"
ut_setupevents "SCX", "CPU1", {FMAppName}, FM_COPY_SRC_INVALID_ERR_EID, "ERROR", 1

cmdctr = SCX_CPU1_FM_CMDPC + 1
errcnt = SCX_CPU1_FM_CMDEC + 1

/scx_cpu1_FM_FileCopy Overwrite=0 File="" DestName=testDestDir & "/LONG111.TST"
...
if (SCX_CPU1_FM_CMDEC = errcnt) then
  ...
  if (SCX_CPU1_find_event[1].num_found_messages = 1) THEN
    ...
    write "<!> Failed (1004) - Event message ", SCX_CPU1_evs_eventid," received. Expected Event message ",FM_COPY_SRC_INVALID_ERR_EID, "."
    ut_setrequirements FM_1004, "F"
  endif
else
...
/scx_cpu1_FM_FileCopy Overwrite=0 File=fullTestLongName1 DestName=testDestDir & "/LONG111.TST"
...
if (SCX_CPU1_FM_CMDPC = cmdctr) then
  ...
  if (SCX_CPU1_find_event[1].num_found_messages = 1) THEN
    ...
    write "<!> Failed (1003) - Event message ",SCX_CPU1_evs_eventid," received. Expected Event message ",FM_COPY_CMD_EID, "."
    ut_setrequirements FM_1003, "F"
  endif
else
...
s scx_cpu1_fm_fileinfodisplay (testDestDir & "/LONG111.TST")
...
if (SCX_CPU1_FM_CMDPC = cmdctr) then
  ...
  if (SCX_CPU1_FM_FileStatus > 1) THEN
...
/scx_cpu1_FM_FileCopy Overwrite=0 File=fullTestLongName2 DestName=testDestDir & "/LONG222.TST"
...
s scx_cpu1_fm_fileinfodisplay (testDestDir & "/LONG222.TST")
...
/scx_cpu1_FM_FileCopy Overwrite=0 File=fullTestLongName3 DestName=testDestDir & "/LONG333.TST"
...
s scx_cpu1_fm_fileinfodisplay (testDestDir & "/LONG333.TST")
...
/scx_cpu1_FM_FileCopy Overwrite=0 File=fullTestShortName DestName=testDestDir & "/SHORTEST.TST"
...
write ";*********************************************************************"
ut_setupevents "SCX", "CPU1", {FMAppName}, FM_COPY_TGT_INVALID_ERR_EID, "ERROR", 1

cmdctr = SCX_CPU1_FM_CMDPC + 1
errcnt = SCX_CPU1_FM_CMDEC + 1

/scx_cpu1_FM_FileCopy Overwrite=0 File=fullOriginalTestFileName DestName=""
...
if (SCX_CPU1_FM_CMDEC = errcnt) then
  ...
  if (SCX_CPU1_find_event[1].num_found_messages = 1) THEN
    ...
    write "<!> Failed (1004) - Event message ", SCX_CPU1_evs_eventid," received. Expected Event message ",FM_COPY_TGT_INVALID_ERR_EID, "."
    ut_setrequirements FM_1003, "F"
  endif
else
  write "<!> Failed (1004;1005) - Command Accepted zero character file name!"
...
/scx_cpu1_FM_FileCopy Overwrite=0 File=fullOriginalTestFileName DestName=longDirName1 & "/FMLONG1.TST"
...
s scx_cpu1_fm_fileinfodisplay (longDirName1 & "/FMLONG1.TST")
...
/scx_cpu1_FM_FileCopy Overwrite=0 File=fullOriginalTestFileName DestName=longDirName2 & "/FMLONG2.TST"
...
s scx_cpu1_fm_fileinfodisplay (longDirName2 & "/FMLONG2.TST")
...
/scx_cpu1_FM_FileCopy Overwrite=0 File=fullOriginalTestFileName DestName=longDirName3 & "/FMLONG3.TST"
...
s scx_cpu1_fm_fileinfodisplay (longDirName3 & "/FMLONG3.TST")
...
/scx_cpu1_FM_FileCopy Overwrite=0 File=fullOriginalTestFileName DestName=ramDir & "/B"
...
/scx_cpu1_FM_FileCopy Overwrite=0 File=fullTestFileName1 DestName=testDestDir & "/FMZEROLEN1.TST"
...
cmdctr = SCX_CPU1_FM_CHILDCMDPC + 1
errcnt = SCX_CPU1_FM_CHILDCMDEC + 1

/scx_cpu1_FM_FileCopy Overwrite=0 File=fullTestFileName2 DestName=testDestDir & "/FMLARGE1.TST"

wait until ((SCX_CPU1_FM_CHILDCMDPC = cmdctr) OR (SCX_CPU1_FM_CHILDCMDEC = errcnt))
if (SCX_CPU1_FM_CHILDCMDPC = cmdctr) then
  write "<*> Passed (1003;2002) - Copy Command Accepted."
  ut_setrequirements FM_1003, "P"
  ut_setrequirements FM_2002, "P"
...
elseif (SCX_CPU1_FM_CHILDCMDEC = errcnt) then
  ...
  if (SCX_CPU1_find_event[2].num_found_messages = 1) THEN
    write "<*> Passed (1004) - Event message ", SCX_CPU1_find_event[2].eventid, " received"
    ut_setrequirements FM_1004, "P"
  else
    write "<!> Failed (1004) - Event message ", SCX_CPU1_evs_eventid," received. Expected Event message ", FM_COPY_OS_ERR_EID, "."
    ut_setrequirements FM_1004, "F"
...
/scx_cpu1_FM_FileCopy Overwrite=0 File=fullOriginalTestFileName DestName=testDestDir2 & forwardSlash & testFile
...
s scx_cpu1_fm_fileinfodisplay (testDestDir2 & forwardSlash & testFile)
...
/scx_cpu1_FM_FileCopy Overwrite=0 File=fullTestFileName2 DestName=testDestDir2 & forwardSlash & testFile4

wait until (((SCX_CPU1_FM_CMDPC = cmdctr) AND ;;
	     (SCX_CPU1_FM_CHILDCMDPC = childCmdCtr)) OR ;;
	     (SCX_CPU1_FM_CMDEC = errcnt))
if (SCX_CPU1_FM_CMDPC = cmdctr AND SCX_CPU1_FM_CHILDCMDPC = childCmdCtr) then
  write "<*> Passed (1003;2002) - Copy Command Accepted."
  ut_setrequirements FM_1003, "P"
  ut_setrequirements FM_2002, "P"
...
s scx_cpu1_fm_fileinfodisplay (testDestDir2 & forwardSlash & testFile4)
...
/scx_cpu1_FM_Delete File=testDestDir2 & forwardSlash & testFile
...
if (SCX_CPU1_FM_CMDPC = cmdctr) then
  ...
  if (SCX_CPU1_find_event[1].num_found_messages = 1) THEN
    ...
    write "<!> Failed (1003) - Event message ", SCX_CPU1_evs_eventid," received. Expected Event message ", FM_DELETE_CMD_EID, "."
    ut_setrequirements FM_1003, "F"
  endif
else
...
/scx_cpu1_FM_Delete File=testDestDir2 & forwardSlash & testFile4
...
write ";*********************************************************************"
write ";  End procedure SCX_CPU1_fm_filecopy_stress                          "
write ";*********************************************************************"
ENDPROC
