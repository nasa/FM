PROC scx_cpu1_fm_runspecialchartests (directorySpec)
;*******************************************************************************
...
if (directorySpec <> "") then
  s ut_runproc("scx_cpu1_fm_specialchars1",directorySpec)
else
  s ut_runproc("scx_cpu1_fm_specialchars1")
endif
wait 2
...
write ";*********************************************************************"
if (directorySpec <> "") then
  s ut_runproc("scx_cpu1_fm_specialchars2",directorySpec)
else
  s ut_runproc("scx_cpu1_fm_specialchars2")
endif
wait 2
...
write ";*********************************************************************"
if (directorySpec <> "") then
  s ut_runproc("scx_cpu1_fm_specialchars3",directorySpec)
else
  s ut_runproc("scx_cpu1_fm_specialchars3")
endif
wait 2
...
write ";*********************************************************************"
if (directorySpec <> "") then
  s ut_runproc("scx_cpu1_fm_specialchars4",directorySpec)
else
  s ut_runproc("scx_cpu1_fm_specialchars4")
endif
wait 2
...
write ";*********************************************************************"
if (directorySpec <> "") then
  s ut_runproc("scx_cpu1_fm_specialchars5",directorySpec)
else
  s ut_runproc("scx_cpu1_fm_specialchars5")
endif
wait 2

write ";*********************************************************************"
write ";  End procedure scx_cpu1_fm_runspecialchartests "
write ";*********************************************************************"
ENDPROC
