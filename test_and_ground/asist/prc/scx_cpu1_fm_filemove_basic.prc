PROC scx_cpu1_fm_filemove_basic
;*******************************************************************************
...
s scx_cpu1_fm_fileinfodisplay (currentSrcFile)
...
if (cmdctr = SCX_CPU1_FM_CMDPC) then
  ...
  if (SCX_CPU1_FM_InfoFileName = currentSrcFile) THEN
...
s scx_cpu1_fm_fileinfodisplay (fullTestFileMove1Name)
...
/SCX_CPU1_FM_FileMove Overwrite=0 File=currentSrcFile DestName=testDir2
...
/SCX_CPU1_FM_FileMove Overwrite=0 File=testDir1 DestName=fullTestFileMove1Name
...
s scx_cpu1_fm_fileinfodisplay (fullTestFileMove2Name)
...
/SCX_CPU1_FM_FileMove Overwrite=0 File=currentSrcFile DestName=fullTestFileMove2Name
...
s scx_cpu1_fm_fileinfodisplay (lastSrcFile)
...
if (cmdctr = SCX_CPU1_FM_CMDPC) then
  ...
  if (p@SCX_CPU1_FM_FileStatus = "Not Used") THEN
    ...
    write "<!> Failed (2004) - File Info Telemetry indicates a status of '",p@SCX_CPU1_FM_FIleStatus, "'. Expected 'Not Used'"
    ut_setrequirements FM_2004, "F"
  endif
else
  write "<!> Failed (1003;2011) - File Info Command incremented the CMDEC."
...
if (cmdctr = SCX_CPU1_FM_CMDPC) then
  ...
  if (SCX_CPU1_FM_InfoFileName = fullTestFileMove2Name) THEN
...
s scx_cpu1_fm_fileinfodisplay (fullTestFileMove3Name)
...
/SCX_CPU1_FM_FileMove Overwrite=0 File=currentSrcFile DestName=fullTestFileMove3Name
...
if (cmdctr = SCX_CPU1_FM_CMDPC) then
  ...
  if (SCX_CPU1_FM_InfoFileName = fullTestFileMove3Name) THEN
    write "<*> Passed (2004;2011) - File Info Telemetry Matches expected file: ", fullTestFileMove2Name
    ut_setrequirements FM_2004, "P"
    ut_setrequirements FM_2011, "P"
  else
...
/SCX_CPU1_TST_FM_Open File=currentSrcFile
...
/SCX_CPU1_FM_FileMove Overwrite=0 File=currentSrcFile DestName=testDir2 & "/openSrc.tst"

ut_tlmwait SCX_CPU1_FM_CMDPC, {cmdctr}
if (UT_TW_Status = UT_Success) then
  write "<*> Passed (1004;2004) - Command Accepted Counter incremented as expected."
  ut_setrequirements FM_1004, "P"
  ut_setrequirements FM_2004, "P"
  ...
  if (SCX_CPU1_find_event[1].num_found_messages = 1) THEN
    ...
    write "<!> Failed (1004) - Event message ",SCX_CPU1_evs_eventid," received. Expected Event message ",FM_MOVE_CMD_EID
    ut_setrequirements FM_1004, "F"
  endif
else
  write "<!> Failed (1004;2004) - Move Command rejected with an open file."
  ut_setrequirements FM_1004, "F"
  ut_setrequirements FM_2004, "F"
endif
...
write ";*********************************************************************"
write ";  Step 4.9.4: Verify the destination file exists."
write ";*********************************************************************"
ut_setupevents "SCX", "CPU1", {FMAppName}, FM_GET_FILE_INFO_CMD_EID, "DEBUG", 1

cmdctr = SCX_CPU1_FM_CMDPC + 1

s scx_cpu1_fm_fileinfodisplay (testDir2 & "/openSrc.tst")
...
if (cmdctr = SCX_CPU1_FM_CMDPC) then
  ...
  if (p@SCX_CPU1_FM_FileStatus = "Open") THEN
    ...
    write "<!> Failed - File Info Telemetry indicates a status of '",p@SCX_CPU1_FM_FIleStatus, "'. Expected 'Open'"
  endif
else
  write "<!> Failed (1003;2011) - File Info Command incremented the CMDEC"
  ut_setrequirements FM_1003, "F"
...
/SCX_CPU1_TST_FM_Close File=currentSrcFile

ut_tlmwait  SCX_CPU1_TST_FM_CMDPC, {cmdctr}
if (UT_TW_Status = UT_Success) then
  write "<*> Passed - Close File command for sent properly."
else
  write "<!> Failed - Close File command. CMDPC = ",SCX_CPU1_TST_FM_CMDPC,"; Expected ",cmdctr
endif
...
/SCX_CPU1_FM_FileMove Overwrite=0 File=fullOriginalTestFileName DestName=testDir2 & "/openSrc.tst"
...
/SCX_CPU1_FM_FileMove Overwrite=1 File=fullOriginalTestFileName DestName=currentSrcFile
...
write ";*********************************************************************"
write ";  End procedure scx_cpu1_fm_filemove_basic  "
write ";*********************************************************************"
ENDPROC
