PROC scx_cpu1_fm_runstresstests (directorySpec)
;*******************************************************************************
...
if (directorySpec <> "") then
  s ut_runproc("scx_cpu1_fm_dircmds_stress",directorySpec)
else
  s ut_runproc("scx_cpu1_fm_dircmds_stress")
endif
wait 2
...
write ";*********************************************************************"
if (directorySpec <> "") then
  s ut_runproc("scx_cpu1_fm_filecat_stress",directorySpec)
else
  s ut_runproc("scx_cpu1_fm_filecat_stress")
endif
wait 2
...
write ";*********************************************************************"
if (directorySpec <> "") then
  s ut_runproc("scx_cpu1_fm_filecopy_stress",directorySpec)
else
  s ut_runproc("scx_cpu1_fm_filecopy_stress")
endif
wait 2
...
write ";*********************************************************************"
if (directorySpec <> "") then
  s ut_runproc("scx_cpu1_fm_filedecom_stress",directorySpec)
else
  s ut_runproc("scx_cpu1_fm_filedecom_stress")
endif
wait 2
...
write ";*********************************************************************"
if (directorySpec <> "") then
  s ut_runproc("scx_cpu1_fm_filedelete_stress",directorySpec)
else
  s ut_runproc("scx_cpu1_fm_filedelete_stress")
endif
wait 2
...
write ";*********************************************************************"
if (directorySpec <> "") then
  s ut_runproc("scx_cpu1_fm_fileinfo_stress",directorySpec)
else
  s ut_runproc("scx_cpu1_fm_fileinfo_stress")
endif
wait 2
...
write ";*********************************************************************"
if (directorySpec <> "") then
  s ut_runproc("scx_cpu1_fm_filemove_stress",directorySpec)
else
  s ut_runproc("scx_cpu1_fm_filemove_stress")
endif
wait 2
...
write ";*********************************************************************"
if (directorySpec <> "") then
  s ut_runproc("scx_cpu1_fm_filerename_stress",directorySpec)
else
  s ut_runproc("scx_cpu1_fm_filerename_stress")
endif
wait 2

write ";*********************************************************************"
write ";  End procedure scx_cpu1_fm_runstresstests                           "
write ";*********************************************************************"
ENDPROC
