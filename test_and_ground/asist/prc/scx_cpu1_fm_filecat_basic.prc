PROC scx_cpu1_fm_filecat_basic
;*******************************************************************************
...
/SCX_CPU1_FM_DirCreate DirName=testDir3
...
s ftp_file (uploadDir1, testFile1, testFile1, hostCPU, "P")
s ftp_file (uploadDir1, testFile2, testFile2, hostCPU, "P")
s ftp_file (uploadDir2, testFile3, testFile3, hostCPU, "P")
...
s scx_cpu1_fm_fileinfodisplay (fullOutputFile1Name)
...
/SCX_CPU1_FM_FileCat File1=fullTestFile1Name File2=fullTestFile2Name DestName=fullOutputFile1Name
...
if ( SCX_CPU1_FM_InfoFileName = fullOutputFile1Name ) THEN
...
s scx_cpu1_fm_fileinfodisplay (fullOutputFile2Name)
...
/SCX_CPU1_FM_FileCat File1=fullTestFile1Name File2=fullTestFile2Name DestName=fullOutputFile2Name
...
if (SCX_CPU1_FM_InfoFileName = fullOutputFile2Name) THEN
...
s scx_cpu1_fm_fileinfodisplay (fullOutputFile3Name)
...
/SCX_CPU1_FM_FileCat File1=fullTestFile1Name File2=fullTestFile3Name DestName=fullOutputFile3Name
...
if (SCX_CPU1_FM_InfoFileName = fullOutputFile3Name) THEN
...
s scx_cpu1_fm_fileinfodisplay (fullOutputFile4Name)
...
/SCX_CPU1_FM_FileCat File1=fullTestFile1Name File2=fullTestFile3Name DestName=fullOutputFile4Name
...
if (SCX_CPU1_FM_InfoFileName = fullOutputFile4Name) THEN
...
s scx_cpu1_fm_fileinfodisplay (fullOutputFile5Name)
...
/SCX_CPU1_FM_FileCat File1=fullTestFile1Name File2=fullTestFile3Name DestName=fullOutputFile5Name
...
if (SCX_CPU1_FM_InfoFileName = fullOutputFile5Name) THEN
...
errcnt = SCX_CPU1_TST_FM_CMDEC + 1
local expOpenCnt = SCX_CPU1_FM_NumOpen + 1

/SCX_cpu1_TST_FM_Open File=fullTestFile1Name

wait until ((SCX_CPU1_TST_FM_CMDPC = cmdctr) OR (SCX_CPU1_TST_FM_CMDEC = errcnt))
if (SCX_CPU1_TST_FM_CMDPC = cmdctr) then
...
if (SCX_CPU1_find_event[1].num_found_messages = 1) THEN
  ...
  write "  Event message ",SCX_CPU1_evs_eventid," received. Expected Event message ",TST_FM_OPENFILE_INF_EID, "."
endif
...
if (cmdctr = SCX_CPU1_FM_CMDPC) then
  ...
  if (SCX_CPU1_find_event[1].num_found_messages = 1) THEN
    ...
    write "<!> Failed - Did not receive EM ", SCX_CPU1_find_event[1].eventid, " Either the wrong EM is expected or the wrong one was received."
  endif
else
...
if (SCX_CPU1_FM_NumOpen = expOpenCnt) THEN
  write "<*> Passed - HK Telemetry Reports number of open files correctly: ", SCX_CPU1_FM_NumOpen
else
  write "<!> Failed - HK Telemetry Reports number of open files incorrectly: ", SCX_CPU1_FM_NumOpen
endif
...
write ";*********************************************************************"
ut_setupevents "SCX", "CPU1", {FMAppName}, FM_CONCAT_SRC1_OPEN_ERR_EID, "ERROR", 1

cmdctr = SCX_CPU1_FM_CMDPC + 1
errcnt = SCX_CPU1_FM_CMDEC + 1

/SCX_CPU1_FM_FileCat File1=fullTestFile1Name, File2=fullTestFile2Name, DestName= testDir3 & "/openSrc1.tst"
...
if (SCX_CPU1_FM_CMDEC = errcnt) then
  ...
  if (SCX_CPU1_find_event[1].num_found_messages = 1) THEN
    ...
    write "<!> Failed (1003) - Did not receive the expected EM. Rcvd ", SCX_CPU1_find_event[1].eventid, " expected ",FM_CONCAT_SRC1_OPEN_ERR_EID
    ut_setrequirements FM_1003, "F"
  endif
else
...
write ";*********************************************************************"
ut_setupevents "SCX", "CPU1", {FMAppName}, FM_CONCAT_SRC2_OPEN_ERR_EID, "ERROR", 1

cmdctr = SCX_CPU1_FM_CMDPC + 1
errcnt = SCX_CPU1_FM_CMDEC + 1

/SCX_CPU1_FM_FileCat File1=fullTestFile2Name, File2=fullTestFile1Name, DestName= testDir3 & "/openSrc2.tst"
...
if (SCX_CPU1_FM_CMDEC = errcnt) then
  ...
  if (SCX_CPU1_find_event[1].num_found_messages = 1) THEN
    ...
    write "<!> Failed (1003) - Did not receive the expected EM. Rcvd ", SCX_CPU1_find_event[1].eventid, " expected ",FM_CONCAT_SRC2_OPEN_ERR_EID
    ut_setrequirements FM_1003, "F"
  endif
else
...
/SCX_CPU1_FM_FileCat File1=fullTestFile2Name File2=fullTestFile3Name DestName=fullOutputFile5Name
...
if (SCX_CPU1_find_event[1].num_found_messages = 1) THEN
  ...
  write "<!> Failed (1004) - Event message ",SCX_CPU1_evs_eventid," received. Expected Event message ", FM_CONCAT_TGT_EXIST_ERR_EID, "."
  ut_setrequirements FM_1004, "F"
endif
...
write ";*********************************************************************"
write ";  End procedure scx_cpu1_fm_filecat_basic                            "
write ";*********************************************************************"
ENDPROC
