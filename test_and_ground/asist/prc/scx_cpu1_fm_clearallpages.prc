PROC scx_cpu1_fm_clearallpages
;*******************************************************************************
...
clear SCX_CPU1_FM_HK

write "Clearing FM File Info Page."
clear SCX_CPU1_FM_FILE_INFO

write "Clearing FM Dir List File Page."
clear SCX_CPU1_FM_DIR_LIST_FILE

write "Clearing FM Dir List Tlm Page."
clear SCX_CPU1_FM_DIR_LIST

write "Clearing FM Open File List Page."
clear SCX_CPU1_FM_OPEN_FILE_LIST

write "Clearing FM Free Space Table Page."
clear SCX_CPU1_FM_FREESPACE_TABLE

write "Clearing FM Free Space TLM Page."
clear SCX_CPU1_FM_FREESPACE_TLM

write "Clearing TST FM HK Page."
clear SCX_CPU1_TST_FM_HK

write ";*********************************************************************"
write ";  End procedure scx_cpu1_fm_clearallpages  "
write ";*********************************************************************"
ENDPROC
