PROC scx_cpu1_fm_filedecom_stress
;*******************************************************************************
...
write ";*********************************************************************"
ut_setupevents "SCX", "CPU1", {FMAppName}, FM_DECOM_PKT_ERR_EID, "ERROR", 1
...
if (SCX_CPU1_FM_CMDEC = errcnt) then
  ...
  if (SCX_CPU1_find_event[1].num_found_messages = 1) THEN
    ...
    write "<!> Failed (1004) - Received EM ", SCX_CPU1_evs_eventid, "; Expected ",FM_DECOM_PKT_ERR_EID
...
write ";*********************************************************************"
ut_setupevents "SCX", "CPU1", {FMAppName}, FM_DECOM_SRC_DNE_ERR_EID, "ERROR", 1

cmdctr = SCX_CPU1_FM_CMDPC + 1
errcnt = SCX_CPU1_FM_CMDEC + 1

/SCX_CPU1_FM_Decompress File=badPath, DestName=testDestDir & "/invalidSrcPath.tst"
...
if (SCX_CPU1_FM_CMDEC = errcnt) then
  ...
  if (SCX_CPU1_find_event[1].num_found_messages = 1) THEN
    ...
    write "<!> Failed (1004) - Received EM ", SCX_CPU1_evs_eventid, "; Expected ",FM_DECOM_SRC_DNE_ERR_EID
    ut_setrequirements FM_1004, "F"
  endif
else
...
ut_setupevents "SCX", "CPU1", {FMAppName}, FM_DECOM_SRC_ISDIR_ERR_EID, "ERROR", 1

cmdctr = SCX_CPU1_FM_CMDPC + 1
errcnt = SCX_CPU1_FM_CMDEC + 1

/SCX_CPU1_FM_Decompress File=testSourceDir & forwardSlash & "" DestName=testDestDir & "/invalidSrcName.tst"
...
if (SCX_CPU1_FM_CMDEC = errcnt) then
  ...
  if (SCX_CPU1_find_event[1].num_found_messages = 1) THEN
    ...
    write "<!> Failed (1004) - Received EM ", SCX_CPU1_evs_eventid, "; Expected ",FM_DECOM_SRC_ISDIR_ERR_EID
    ut_setrequirements FM_1004, "F"
  endif
else  
...
s scx_cpu1_fm_fileinfodisplay (testDestDir & "/invalidSrcName.tst")
...
/SCX_CPU1_FM_Decompress File=testSourceDir & forwardSlash & "nonexist.tst" DestName=testDestDir & "/invalidSrcName2.tst"
...
s scx_cpu1_fm_fileinfodisplay (testDestDir & "/invalidSrcName2.tst")
...
write ";*********************************************************************"
ut_setupevents "SCX", "CPU1", {FMAppName}, FM_DECOM_CFE_ERR_EID, "ERROR", 1

cmdctr = SCX_CPU1_FM_CHILDCMDPC + 1
errcnt = SCX_CPU1_FM_CHILDCMDEC + 1

/SCX_CPU1_FM_Decompress File=fullTestFileName1 DestName=testDestDir & "/invalidSrcName3.tst"
...
if (SCX_CPU1_FM_CHILDCMDEC = errcnt) then
  ...
  if (SCX_CPU1_find_event[1].num_found_messages = 1) THEN
    ...
    write "<!> Failed (1004) - Received EM ", SCX_CPU1_evs_eventid, "; Expected ",FM_DECOM_CFE_ERR_EID
    ut_setrequirements FM_1004, "F"
  endif
else 
...
s scx_cpu1_fm_fileinfodisplay (testDestDir & "/invalidSrcName3.tst")
...
/SCX_CPU1_FM_DeleteAll DirName=testDestDir
wait 5

if (SCX_CPU1_find_event[1].num_found_messages = 1) THEN
  write "<*> Passed - Event message ",SCX_CPU1_find_event[1].eventid, " received for the Delete All command."
else
  write "<!> Failed - Event message ",SCX_CPU1_find_event[1].eventid, " was not received."
endif
...
write ";*********************************************************************"
ut_setupevents "SCX", "CPU1", {FMAppName}, FM_DECOM_TGT_EXIST_ERR_EID, "ERROR", 1

cmdctr = SCX_CPU1_FM_CMDPC + 1
errcnt = SCX_CPU1_FM_CMDEC + 1

/SCX_CPU1_FM_Decompress File=fullOriginalTestFileName DestName=fullOriginalTestFileName
...
if (SCX_CPU1_FM_CMDEC = errcnt) then
  ...
  if (SCX_CPU1_find_event[1].num_found_messages = 1) THEN
    ...
    write "<!> Failed (1004) - Event message ",SCX_CPU1_evs_eventid," received. Expected Event message ",FM_DECOM_TGT_EXIST_ERR_EID, "."
    ut_setrequirements FM_1004, "F"
  endif
else
...
write ";*********************************************************************"
ut_setupevents "SCX", "CPU1", {FMAppName}, FM_DECOM_SRC_INVALID_ERR_EID, "ERROR", 1

cmdctr = SCX_CPU1_FM_CMDPC + 1
errcnt = SCX_CPU1_FM_CMDEC + 1

/SCX_CPU1_FM_Decompress File="" DestName=testDestDir & "/LONG111.TST"
...
if ( SCX_CPU1_FM_CMDEC = errcnt ) then
  ...
  if (SCX_CPU1_find_event[1].num_found_messages = 1) THEN
    ...
    write "<!> Failed (1004) - Received EM ", SCX_CPU1_evs_eventid, "; Expected ",FM_DECOM_SRC_INVALID_ERR_EID
    ut_setrequirements FM_1004, "F"
  endif
else
...
/SCX_CPU1_FM_Decompress File=fullTestLongName1 DestName=testDestDir & "/LONG111.TST"
...
if (SCX_CPU1_FM_CMDPC = cmdctr) then
  ...
  if (SCX_CPU1_find_event[1].num_found_messages = 1) THEN
    ...
    write "<!> Failed (1003) - Event message ",SCX_CPU1_evs_eventid," received. Expected Event message ", FM_DECOM_CMD_EID, "."
    ut_setrequirements FM_1003, "F"
  endif
else
...
/SCX_CPU1_FM_Decompress File=fullTestLongName2 DestName=testDestDir & "/LONG222.TST"
...
/SCX_CPU1_FM_Decompress File=fullTestLongName3, DestName=testDestDir & "/LONG333.TST"
...
/SCX_CPU1_FM_Decompress File=fullTestShortName DestName=testDestDir & "/SHORT_TEST.TST"
...
write ";*********************************************************************"
ut_setupevents "SCX", "CPU1", {FMAppName}, FM_DECOM_TGT_INVALID_ERR_EID, "ERROR", 1

cmdctr = SCX_CPU1_FM_CMDPC + 1
errcnt = SCX_CPU1_FM_CMDEC + 1

/SCX_CPU1_FM_Decompress File=fullOriginalTestFileName DestName=""
...
if ( SCX_CPU1_FM_CMDEC = errcnt ) then
  ...
  if (SCX_CPU1_find_event[1].num_found_messages = 1) THEN
    ...
    write "<!> Failed (1004) - Received EM ", SCX_CPU1_evs_eventid, "; Expected ",FM_DECOM_TGT_INVALID_ERR_EID
    ut_setrequirements FM_1004, "F"
  endif
else
  write "<!> Failed (1004;1005) - Command Accepted zero character file name!"
...
/SCX_CPU1_FM_Decompress File=fullOriginalTestFileName DestName=longDirName1 & "/FMLONG1.TST"
...
if (SCX_CPU1_FM_CMDPC = cmdctr) then
  ...
  if (SCX_CPU1_find_event[1].num_found_messages = 1) THEN
    ...
    write "<!> Failed (1003) - Received EM ", SCX_CPU1_evs_eventid, "; Expected ",FM_GET_FILE_INFO_CMD_EID
    ut_setrequirements FM_1003, "F"
  endif
...
/SCX_CPU1_FM_Decompress File=fullOriginalTestFileName DestName=longDirName2 & "/FMLONG2.TST"
...
/SCX_CPU1_FM_Decompress File=fullOriginalTestFileName DestName=longDirName3 & "/FMLONG3.TST"
...
/SCX_CPU1_FM_Decompress File=fullOriginalTestFileName DestName=ramDir & "/B"
...
write ";*********************************************************************"
ut_setupevents "SCX", "CPU1", {FMAppName}, FM_DECOM_TGT_ISDIR_ERR_EID, "ERROR", 1

cmdctr = SCX_CPU1_FM_CMDPC + 1
errcnt = SCX_CPU1_FM_CMDEC + 1

/SCX_CPU1_FM_Decompress DestName=testSourceDir & forwardSlash & "" File=fullOriginalTestFileName
...
if (SCX_CPU1_FM_CMDEC = errcnt) then
  ...
  if (SCX_CPU1_find_event[1].num_found_messages = 1) THEN
    ...
    write "<!> Failed (1004) - Received EM ", SCX_CPU1_evs_eventid, "; Expected ",FM_DECOM_TGT_ISDIR_ERR_EID
    ut_setrequirements FM_1004, "F"
  endif
else  
...
/SCX_CPU1_FM_Decompress DestName=badPath File=fullOriginalTestFileName
...
write ";*********************************************************************"
write ";  End procedure scx_cpu1_fm_filedecom_stress                         "
write ";*********************************************************************"
ENDPROC
