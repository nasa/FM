PROC scx_cpu1_fm_filecat_stress
;*******************************************************************************
...
/SCX_CPU1_FM_DirCreate DirName= testDir
...
/SCX_CPU1_FM_DirCreate DirName=outdir
...
/SCX_CPU1_FM_DirCreate DirName=spDir1
...
/SCX_CPU1_FM_DirCreate DirName=spDir2
...
;; Upload the Test file
s ftp_file (uploadDir, testFile1, testFile1, hostCPU, "P")
wait 5
...
write ";*********************************************************************"
ut_setupevents "SCX", "CPU1", {FMAppName}, FM_CONCAT_PKT_ERR_EID, "ERROR", 1
...
if (SCX_CPU1_FM_CMDEC = errcnt) then
  ...
  if (SCX_CPU1_find_event[1].num_found_messages = 1) THEN
    write "<*> Passed (1002) - Event message ", SCX_CPU1_find_event[1].eventid, " received"
    ut_setrequirements FM_1002, "P"
  else
    write "<!> Failed (1002) - Did not receive expected EM. Rcvd ", SCX_CPU1_evs_eventid, " expected ",FM_CONCAT_PKT_ERR_EID
...
write ";*********************************************************************"
ut_setupevents "SCX", "CPU1", {FMAppName}, FM_CONCAT_SRC1_DNE_ERR_EID, "ERROR", 1

cmdctr = SCX_CPU1_FM_CMDPC + 1
errcnt = SCX_CPU1_FM_CMDEC + 1

/SCX_CPU1_FM_FileCat File1=badPath File2=fullTestFile2Name DestName= outDir & forwardSlash & outputfile & outfilenum & extension
...
if (SCX_CPU1_FM_CMDEC = errcnt) then
  ...
  if (SCX_CPU1_find_event[1].num_found_messages = 1) THEN
    ...
    write "<!> Failed (1004) - Did not receive expected EM. Rcvd ", SCX_CPU1_evs_eventid, " expected ",FM_CONCAT_SRC1_DNE_ERR_EID
    ut_setrequirements FM_1004, "F"
  endif
else
...
write ";*********************************************************************"
ut_setupevents "SCX", "CPU1", {FMAppName}, FM_GET_FILE_INFO_CMD_EID, "DEBUG", 1

cmdctr = SCX_CPU1_FM_CMDPC + 1
errcnt = SCX_CPU1_FM_CMDEC + 1

s scx_cpu1_fm_fileinfodisplay (outDir & forwardSlash & outputfile & outfilenum & extension)
...
if (SCX_CPU1_FM_CMDPC = cmdctr) then
  ...
  if (SCX_CPU1_find_event[1].num_found_messages = 1) THEN
    ...
    write "<!> Failed (1003) - Did not receive expected EM. Rcvd ", SCX_CPU1_evs_eventid, " expected ",FM_GET_FILE_INFO_CMD_EID
    ut_setrequirements FM_1003, "F"
  endif

  if (p@SCX_CPU1_FM_FileStatus = "Not Used") THEN
...
write ";*********************************************************************"
ut_setupevents "SCX", "CPU1", {FMAppName}, FM_CONCAT_SRC1_ISDIR_ERR_EID, "ERROR", 1

cmdctr = SCX_CPU1_FM_CMDPC + 1
errcnt = SCX_CPU1_FM_CMDEC + 1

/SCX_CPU1_FM_FileCat File1= testdir & forwardSlash & "" File2=fullTestFile2Name DestName= outDir & forwardSlash & outputfile & outfilenum & extension
...
if (SCX_CPU1_FM_CMDEC = errcnt) then
  ...
  if (SCX_CPU1_find_event[1].num_found_messages = 1) THEN
    ...
    write "<!> Failed (1004) - Did not receive expected EM. Rcvd ", SCX_CPU1_evs_eventid, " expected ",FM_CONCAT_SRC1_ISDIR_ERR_EID
  endif
else
...
write ";*********************************************************************"
ut_setupevents "SCX", "CPU1", {FMAppName}, FM_CONCAT_SRC2_DNE_ERR_EID "ERROR", 1

cmdctr = SCX_CPU1_FM_CMDPC + 1
errcnt = SCX_CPU1_FM_CMDEC + 1

/SCX_CPU1_FM_FileCat File1=fullTestFile1Name File2=badPath DestName= outDir & forwardSlash & outputfile & outfilenum & extension
...
if (SCX_CPU1_FM_CMDEC = errcnt) then
  ...
  if (SCX_CPU1_find_event[1].num_found_messages = 1) THEN
    ...
    write "<!> Failed (1004) - Did not receive expected EM. Rcvd ", SCX_CPU1_evs_eventid, " expected ",FM_CONCAT_SRC2_DNE_ERR_EID
    ut_setrequirements FM_1004, "F"
  endif
else
...
write ";*********************************************************************"
ut_setupevents "SCX", "CPU1", {FMAppName}, FM_CONCAT_SRC2_ISDIR_ERR_EID "ERROR", 1

cmdctr = SCX_CPU1_FM_CMDPC + 1
errcnt = SCX_CPU1_FM_CMDEC + 1

/SCX_CPU1_FM_FileCat File1=fullTestFile1Name File2= testdir & forwardSlash & "" DestName= outDir & forwardSlash & outputfile & outfilenum & extension
...
if (SCX_CPU1_FM_CMDEC = errcnt) then
  ...
  if (SCX_CPU1_find_event[1].num_found_messages = 1) THEN
    ...
    write "<!> Failed (1004) - Did not receive expected EM. Rcvd ", SCX_CPU1_evs_eventid, " expected ",FM_CONCAT_SRC2_ISDIR_ERR_EID
    ut_setrequirements FM_1004, "F"
  endif
else
  write "<!> Failed (1004;1005;2010) - File Cat command completed when failure was expected."
...
write ";*********************************************************************"
ut_setupevents "SCX", "CPU1", {FMAppName}, FM_CONCAT_SRC1_ISDIR_ERR_EID "ERROR", 1
ut_setupevents "SCX", "CPU1", {FMAppName}, FM_CONCAT_SRC2_ISDIR_ERR_EID "ERROR", 2

cmdctr = SCX_CPU1_FM_CMDPC + 1
errcnt = SCX_CPU1_FM_CMDEC + 1

/SCX_CPU1_FM_FileCat File1= spDir1 & forwardSlash & "" File2= spDir2 & forwardSlash & "" DestName= outDir & forwardSlash & outputfile & outfilenum & extension
...
s scx_cpu1_fm_fileinfodisplay (fullTestFile1Name)
...
filesize1 = SCX_CPU1_FM_InfoFileSize
...
write ";*********************************************************************"
ut_setupevents "SCX", "CPU1", {FMAppName}, FM_CONCAT_CMD_EID, "DEBUG", 1

cmdctr = SCX_CPU1_FM_CMDPC + 1
errcnt = SCX_CPU1_FM_CMDEC + 1

/SCX_CPU1_FM_FileCat File1=fullTestFile1Name File2=fullTestFile1Name DestName= outDir & forwardSlash & outputfile & outfilenum & extension
...
filesize2 = SCX_CPU1_FM_InfoFileSize
...
write ";*********************************************************************"
ut_setupevents "SCX", "CPU1", {FMAppName}, FM_CONCAT_OSCPY_ERR_EID, "ERROR", 1
...
/SCX_CPU1_FM_FileCat File1=fullTestFile1Name File2=fullTestFile2Name DestName=badPath
...
if (SCX_CPU1_FM_CHILDCMDEC = errcnt) then
  ...
  if (SCX_CPU1_find_event[1].num_found_messages = 1) THEN
    ...
    write "<!> Failed (1004) - Did not receive expected EM. Rcvd ", SCX_CPU1_evs_eventid, " expected ",FM_CONCAT_OSCPY_ERR_EID
    ut_setrequirements FM_1004, "F"
  endif
else
  write "<!> Failed (1004;1005;2010) - File Cat command completed when failure was expected."
...
s scx_cpu1_fm_fileinfodisplay (badPath)
...
write ";*********************************************************************"
ut_setupevents "SCX", "CPU1", {FMAppName}, FM_CONCAT_TGT_ISDIR_ERR_EID, "ERROR", 1

cmdctr = SCX_CPU1_FM_CMDPC + 1
errcnt = SCX_CPU1_FM_CMDEC + 1

/SCX_CPU1_FM_FileCat File1=fullTestFile1Name File2=fullTestFile2Name DestName= testdir & forwardSlash & ""
...
if (SCX_CPU1_FM_CMDEC = errcnt) then
  ...
  if (SCX_CPU1_find_event[1].num_found_messages = 1) THEN
    ...
    write "<!> Failed (1004) - Did not receive expected EM. Rcvd ", SCX_CPU1_evs_eventid, " expected ",FM_CONCAT_TGT_ISDIR_ERR_EID
    ut_setrequirements FM_1004, "F"
  endif
else
  write "<!> Failed (1004;1005;2010) - File Cat command completed when failure was expected."
...
write ";*********************************************************************"
ut_setupevents "SCX", "CPU1", {FMAppName}, FM_CONCAT_TGT_EXIST_ERR_EID, "ERROR", 1

cmdctr = SCX_CPU1_FM_CMDPC + 1
errcnt = SCX_CPU1_FM_CMDEC + 1

/SCX_CPU1_FM_FileCat File1=fullTestFile1Name File2=fullTestFile2Name DestName=fullTestFile1Name
...
if (SCX_CPU1_FM_CMDEC = errcnt) then
  ...
  if (SCX_CPU1_find_event[1].num_found_messages = 1) THEN
    ...
    write "<!> Failed (1004) - Did not receive expected EM. Rcvd ", SCX_CPU1_evs_eventid, " expected ",FM_CONCAT_TGT_EXIST_ERR_EID
    ut_setrequirements FM_1004, "F"
  endif
else
  write "<!> Failed (1004;1005;2010) - File Cat command completed when failure was expected."
...
/SCX_CPU1_FM_FileCat File1=fullTestFile1Name File2=fullTestFile2Name DestName=fullTestFile2Name
...
write ";*********************************************************************"
ut_setupevents "SCX", "CPU1", {FMAppName}, FM_CONCAT_SRC1_INVALID_ERR_EID, "ERROR", 1

cmdctr = SCX_CPU1_FM_CMDPC + 1
errcnt = SCX_CPU1_FM_CMDEC + 1

/SCX_CPU1_FM_FileCat File1="" File2=fullTestFile2Name DestName=fullTestFile2Name
...
if (SCX_CPU1_FM_CMDEC = errcnt) then
  ...
  if (SCX_CPU1_find_event[1].num_found_messages = 1) THEN
    ...
    write "<!> Failed (1004) - Did not receive expected EM. Rcvd ", SCX_CPU1_evs_eventid, " expected ",FM_CONCAT_SRC1_INVALID_ERR_EID
    ut_setrequirements FM_1004, "F"
  endif
else
...
/SCX_CPU1_FM_FileCat File1=fullTestLongName1 File2=fullTestFile2Name DestName= outDir & "/LONGFILE1_1.TST"
...
s scx_cpu1_fm_fileinfodisplay (outDir & "/LONGFILE1_1.TST")
...
if ( SCX_CPU1_FM_CMDPC = cmdctr ) then
  ...
  if (p@SCX_CPU1_FM_FileStatus = "Closed") THEN
    write "<*> Passed (2010) - File Status indicates File is closed."
    ut_setrequirements FM_2010, "P"
  else
    write "<!> Failed (2010) - File Status indicates '",p@SCX_CPU1_FM_FileStatus,"'. Expected 'Closed'."
    ut_setrequirements FM_2010, "F"
  endif
...
/SCX_CPU1_FM_FileCat File1=fullTestLongName2 File2=fullTestFile2Name DestName= outDir & "/LONGFILE1_2.TST"
...
s scx_cpu1_fm_fileinfodisplay (outDir & "/LONGFILE1_2.TST")
...
/SCX_CPU1_FM_FileCat File1=fullTestLongName3 File2=fullTestFile2Name DestName= outDir & "/LONGFILE1_3.TST"
...
s scx_cpu1_fm_fileinfodisplay (outDir & "/LONGFILE1_3.TST")
...
/SCX_CPU1_FM_FileCat File1=fullTestShortName File2=fullTestFile2Name DestName= outDir & "/SHORTEST1.TST"
...
if (SCX_CPU1_find_event[1].num_found_messages = 1) THEN
  ...
  write "<!> Failed (1003) - Event message ", SCX_CPU1_evs_eventid," received. Expected Event message ", FM_CONCAT_CMD_EID, "."
  ut_setrequirements FM_1003, "F"
endif
...
s scx_cpu1_fm_fileinfodisplay (outDir & "/SHORTEST1.TST")
...
write ";*********************************************************************"
ut_setupevents "SCX", "CPU1", {FMAppName}, FM_CONCAT_SRC2_INVALID_ERR_EID, "ERROR", 1

cmdctr = SCX_CPU1_FM_CMDPC + 1
errcnt = SCX_CPU1_FM_CMDEC + 1

/SCX_CPU1_FM_FileCat File1=fullTestFile1Name File2="" DestName= outDir & "/LONGFILE2_1.TST"
...
if (SCX_CPU1_FM_CMDEC = errcnt) then
  ...
  if (SCX_CPU1_find_event[1].num_found_messages = 1) THEN
    ...
    write "<!> Failed (1004) - Did not receive expected EM. Rcvd ", SCX_CPU1_evs_eventid, " expected ",FM_CONCAT_SRC2_INVALID_ERR_EID
    ut_setrequirements FM_1004, "F"
  endif
else
  write "<!> Failed (1004;1005) - Command Accepted zero character file name!"
...
/SCX_CPU1_FM_FileCat File1= fullTestFile1Name File2= fullTestLongName1 DestName= outDir & "/LONGFILE2_1.TST"
...
s scx_cpu1_fm_fileinfodisplay (outDir & "/LONGFILE2_1.TST")
...
/SCX_CPU1_FM_FileCat File1= fullTestFile1Name File2= fullTestLongName2 DestName= outDir & "/LONGFILE2_2.TST"
...
s scx_cpu1_fm_fileinfodisplay (outDir & "/LONGFILE2_2.TST")
...
/SCX_CPU1_FM_FileCat File1=fullTestFile1Name File2=fullTestLongName3 DestName= outDir & "/LONGFILE2_3.TST"
...
s scx_cpu1_fm_fileinfodisplay (outDir & "/LONGFILE2_3.TST")
...
/SCX_CPU1_FM_FileCat File1=fullTestFile1Name File2=fullTestShortName DestName= outDir & "/SHORTEST2.TST"
...
s scx_cpu1_fm_fileinfodisplay (outDir & "/SHORTEST2.TST")
...
write ";*********************************************************************"
ut_setupevents "SCX", "CPU1", {FMAppName}, FM_CONCAT_TGT_INVALID_ERR_EID, "ERROR", 1

cmdctr = SCX_CPU1_FM_CMDPC + 1
errcnt = SCX_CPU1_FM_CMDEC + 1

/SCX_CPU1_FM_FileCat File1=fullTestFile1Name File2=fullTestFile2Name DestName=""
wait until ((SCX_CPU1_FM_CMDPC = cmdctr) OR (SCX_CPU1_FM_CMDEC = errcnt))
if ( SCX_CPU1_FM_CMDEC = errcnt ) then
  write "<*> Passed (1004;1005) - Command Rejected as expected."
  ut_setrequirements FM_1004, "P"
  ...
  if (SCX_CPU1_find_event[1].num_found_messages = 1) THEN
    ...
    write "<!> Failed (1004) - Did not receive expected EM. Rcvd ", SCX_CPU1_evs_eventid, " expected ",FM_CONCAT_TGT_INVALID_ERR_EID
    ut_setrequirements FM_1004, "F"
  endif
else
  write "<!> Failed (1004;1005) - Command Accepted zero character file name!"
...
/SCX_CPU1_FM_FileCat File1=fullTestFile1Name File2=fullTestFile2Name DestName= longDirName1 & "/OUTLIM1.TST"
...
s scx_cpu1_fm_fileinfodisplay (longDirName1 & "/OUTLIM1.TST")
...
/SCX_CPU1_FM_FileCat File1=fullTestFile1Name File2=fullTestFile2Name DestName= longDirName2 & "/OUTLIM2.TST"
...
s scx_cpu1_fm_fileinfodisplay (longDirName2 & "/OUTLIM2.TST")
...
/SCX_CPU1_FM_FileCat File1=fullTestFile1Name File2=fullTestFile2Name DestName= longDirName3 & "/OUTLIM3.TST"
...
s scx_cpu1_fm_fileinfodisplay (longDirName3 & "/OUTLIM3.TST")
...
/SCX_CPU1_FM_FileCat File1= fullTestFile1Name File2= fullTestFile2Name DestName= ramDir & "/B"
...
s scx_cpu1_fm_fileinfodisplay (ramDir & "/B")
...
write ""
write ";*********************************************************************"
write ";  End procedure scx_cpu1_fm_filecat_stress                           "
write ";*********************************************************************"
ENDPROC
