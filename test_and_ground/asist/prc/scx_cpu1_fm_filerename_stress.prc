PROC scx_cpu1_fm_filerename_stress
;*******************************************************************************
...
write ";*********************************************************************"
ut_setupevents "SCX", "CPU1", {FMAppName}, FM_RENAME_PKT_ERR_EID, "ERROR", 1
...
if (SCX_CPU1_FM_CMDEC = errcnt) then
  ...
  if (SCX_CPU1_find_event[1].num_found_messages = 1) THEN
    ...
    write "<!> Failed (1004) - Event message ",SCX_CPU1_evs_eventid," received. Expected Event message ",FM_RENAME_PKT_ERR_EID, "."
...
write ";*********************************************************************"
ut_setupevents "SCX", "CPU1", {FMAppName}, FM_RENAME_OS_ERR_EID, "ERROR", 1

errcnt = SCX_CPU1_FM_CHILDCMDEC + 1

/SCX_CPU1_FM_FileRename DestName=badPath File=fullOriginalTestFileName
...
if (UT_TW_Status = UT_Success) then
  ...
  if (SCX_CPU1_find_event[1].num_found_messages = 1) THEN
    ...
    write "<!> Failed (1004) - Event message ",SCX_CPU1_evs_eventid," received. Expected Event message ",FM_RENAME_OS_ERR_EID, "."
    ut_setrequirements FM_1004, "F"
  endif
else
...
write ";*********************************************************************"
ut_setupevents "SCX", "CPU1", {FMAppName}, FM_RENAME_TGT_ISDIR_ERR_EID, "ERROR", 1

cmdctr = SCX_CPU1_FM_CMDPC + 1
errcnt = SCX_CPU1_FM_CMDEC + 1

/SCX_CPU1_FM_FileRename DestName=testDestDir & forwardSlash & "" File=fullOriginalTestFileName
...
if ( SCX_CPU1_FM_CMDEC = errcnt) then
  ...
  if (SCX_CPU1_find_event[1].num_found_messages = 1) THEN
    ...
    write "<!> Failed (1004) - Event message ",SCX_CPU1_evs_eventid," received. Expected Event message ",FM_RENAME_TGT_ISDIR_ERR_EID, "."
    ut_setrequirements FM_1004, "F"
  endif
else
  write "<!> Failed (1004;1005;2005) - Command Rejected Counter did not increment as expected."
...
write ";*********************************************************************"
ut_setupevents "SCX", "CPU1", {FMAppName}, FM_RENAME_SRC_DNE_ERR_EID, "ERROR", 1

cmdctr = SCX_CPU1_FM_CMDPC + 1
errcnt = SCX_CPU1_FM_CMDEC + 1

/SCX_CPU1_FM_FileRename File=badPath DestName=testDestDir & "/invalidSrcPath.tst"
...
if (SCX_CPU1_FM_CMDEC = errcnt) then
  ...
  if (SCX_CPU1_find_event[1].num_found_messages = 1) THEN
    ...
    write "<!> Failed (1004) - Event message ",SCX_CPU1_evs_eventid," received. Expected Event message ",FM_RENAME_SRC_DNE_ERR_EID, "."
    ut_setrequirements FM_1004, "F"
  endif
else
  write "<!> Failed (1004;1005;2005) - Command Rejected Counter did not increment as expected."
...
write ";*********************************************************************"
ut_setupevents "SCX", "CPU1", {FMAppName}, FM_RENAME_SRC_ISDIR_ERR_EID, "ERROR", 1

cmdctr = SCX_CPU1_FM_CMDPC + 1
errcnt = SCX_CPU1_FM_CMDEC + 1

/SCX_CPU1_FM_FileRename File=testSourceDir & forwardSlash & "" DestName=testDestDir & "/invalidSrcName.tst"
...
if (SCX_CPU1_FM_CMDEC = errcnt) then
  ...
  if (SCX_CPU1_find_event[1].num_found_messages = 1) THEN
    ...
    write "<!> Failed (1004) - Event message ",SCX_CPU1_evs_eventid," received. Expected Event message ",FM_RENAME_SRC_ISDIR_ERR_EID, "."
    ut_setrequirements FM_1004, "F"
  endif
else  
...
/SCX_CPU1_FM_FileRename File=fullOriginalTestFileName DestName=fullOriginalTestFileName
...
if (UT_TW_Status = UT_Success) then
  ...
  if (SCX_CPU1_find_event[1].num_found_messages = 1) THEN
    ...
    write "<!> Failed (1004) - Event message ",SCX_CPU1_evs_eventid," received. Expected Event message ",FM_RENAME_TGT_EXIST_ERR_EID, "."
    ut_setrequirements FM_1004, "F"
  endif
else
...
write ";*********************************************************************"
ut_setupevents "SCX", "CPU1", {FMAppName}, FM_RENAME_SRC_INVALID_ERR_EID, "ERROR", 1
...
/SCX_CPU1_FM_FileRename File="" DestName=testDestDir & "/LONGTEST_1.TST"
...
if ( SCX_CPU1_FM_CMDEC = errcnt ) then
  ...
  if (SCX_CPU1_find_event[1].num_found_messages = 1) THEN
    ...
    write "<!> Failed (1004) - Event message ",SCX_CPU1_evs_eventid," received. Expected Event message ",FM_RENAME_SRC_INVALID_ERR_EID, "."
    ut_setrequirements FM_1004, "F"
  endif
else
...
/SCX_CPU1_FM_FileRename File=fullTestLongName1 DestName=testDestDir & "/LONGTEST_1.TST"
...
/SCX_CPU1_FM_FileRename File=fullTestLongName2 DestName=testDestDir & "/LONGTEST_2.TST"
...
/SCX_CPU1_FM_FileRename File=fullTestLongName3 DestName=testDestDir & "/LONGTEST_3.TST"
...
/SCX_CPU1_FM_FileRename File=fullTestShortName DestName=testDestDir & "/SHORTEST.TST"
...
ut_setupevents "SCX", "CPU1", {FMAppName}, FM_RENAME_TGT_INVALID_ERR_EID, "ERROR", 1

cmdctr = SCX_CPU1_FM_CMDPC + 1
errcnt = SCX_CPU1_FM_CMDEC + 1

/SCX_CPU1_FM_FileRename File=fullOriginalTestFileName DestName=""
...
if (SCX_CPU1_FM_CMDEC = errcnt) then
  ...
  if (SCX_CPU1_find_event[1].num_found_messages = 1) THEN
    ...
    write "<!> Failed (1004) - Event message ", SCX_CPU1_evs_eventid," received. Expected Event message ", FM_RENAME_TGT_INVALID_ERR_EID, "."
    ut_setrequirements FM_1004, "F"
  endif
else
  write "<!> Failed (1004;1005;2005) - Command Accepted zero character file name!"
...
/SCX_CPU1_FM_FileRename File=fullOriginalTestFileName DestName=longDirName1 & "/FMLONG1.TST"
...
/SCX_CPU1_FM_FileRename File=fullOriginalTestFileName DestName=longDirName2 & "/FMLONG2.TST"
...
/SCX_CPU1_FM_FileRename File=fullOriginalTestFileName DestName=longDirName3 & "/FMLONG3.TST"
...
/SCX_CPU1_FM_FileRename File=fullOriginalTestFileName DestName=ramDir & "/B"
...
/SCX_CPU1_FM_FileRename File=fullTestFileName1 DestName=testDestDir & "/FMZEROLEN1.TST"
...
if (SCX_CPU1_FM_CMDPC = cmdctr) then
  ...
  ;; Upload the Test file
  s ftp_file (uploadDir, testFile3, testFile3, "CPU1", "P")
  wait 4
else
  write "<!> Failed (1003;2005) - Rename Command Rejected."
  ut_setrequirements FM_1003, "F"
...
/SCX_CPU1_FM_FileRename File=fullTestFileName2 DestName=testDestDir & "/FMLARGE1.TST"
...
/SCX_CPU1_FM_FileRename File=fullOriginalTestFileName DestName=testDestDir2 & forwardSlash & testFile
...
write ";*********************************************************************"
write ";  End procedure scx_cpu1_fm_filerename_stress                        "
write ";*********************************************************************"
ENDPROC
