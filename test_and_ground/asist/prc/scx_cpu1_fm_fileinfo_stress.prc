PROC scx_cpu1_fm_fileinfo_stress
;*******************************************************************************
...
write ";*********************************************************************"
ut_setupevents "SCX","CPU1",{FMAppName},FM_GET_FILE_INFO_PKT_ERR_EID,"ERROR", 1
...
if (errcnt = SCX_CPU1_FM_CMDEC) then
  ...
  if (SCX_CPU1_find_event[1].num_found_messages = 1) THEN
    ...
    write "<!> Failed (1004) - Event message ",SCX_CPU1_evs_eventid," received. Expected Event message ",FM_GET_FILE_INFO_PKT_ERR_EID
...
s scx_cpu1_fm_fileinfodisplay (testdir & forwardSlash & "")
...
if (cmdctr = SCX_CPU1_FM_CMDPC) then
  ...
  if (p@scx_cpu1_FM_FileStatus = "Directory") THEN
    ...
    write "<!> Failed - File Info Telemetry indicates a status of '",p@scx_cpu1_FM_FIleStatus, "'. Expected 'Directory'"
  endif

  if (scx_cpu1_FM_InfoFileName = testdir & forwardSlash & "") THEN
...
write ";*********************************************************************"
ut_setupevents "SCX","CPU1",{FMAppName},FM_GET_FILE_INFO_SRC_ERR_EID,"ERROR", 1

cmdctr = SCX_CPU1_FM_CMDPC + 1
errcnt = SCX_CPU1_FM_CMDEC + 1

s scx_cpu1_fm_fileinfodisplay (testdir & forwardSlash & ")",0,"Fail")
...
if (errcnt = SCX_CPU1_FM_CMDEC) then
  ...
  if (SCX_CPU1_find_event[1].num_found_messages = 1) THEN
    write "<*> Passed (1004) - Event message ",SCX_CPU1_find_event[1].eventid, " received (Cmd received)"
    ut_setrequirements FM_1004, "P"
  else
    write "<!> Failed (1004) - Event message ",SCX_CPU1_evs_eventid," received. Expected Event message ",FM_GET_FILE_INFO_SRC_ERR_EID
    ut_setrequirements FM_1004, "F"
  endif
else
...
s scx_cpu1_fm_fileinfodisplay (fullTestLongName1)
...
s scx_cpu1_fm_fileinfodisplay (fullTestLongName2)
...
s scx_cpu1_fm_fileinfodisplay (fullTestLongName3)
...
s scx_cpu1_fm_fileinfodisplay (fullTestShortName)
...
s scx_cpu1_fm_fileinfodisplay (fullTestShortName,1)
...
s scx_cpu1_fm_fileinfodisplay (fullTestShortName,2)
...
s scx_cpu1_fm_fileinfodisplay (fullTestShortName,3)
...
write ";*********************************************************************"
ut_setupevents "SCX","CPU1",{FMAppName},FM_GET_FILE_INFO_CMD_EID, "DEBUG", 1
ut_setupevents "SCX","CPU1",{FMAppName},FM_GET_FILE_INFO_TYPE_WARNING_EID,"INFO", 2

cmdctr = SCX_CPU1_FM_CMDPC + 1

s scx_cpu1_fm_fileinfodisplay (fullTestShortName,4)
...
if (cmdctr = SCX_CPU1_FM_CMDPC) then
  ...
  if (SCX_CPU1_find_event[2].num_found_messages = 1) THEN
    ...
    write "<!> Failed - Expected Event message ",FM_GET_FILE_INFO_TYPE_WARNING_EID," was not received"
  endif
else
  write "<!> Failed (1003;2011) - File Info Command Failed."
  ut_setrequirements FM_1003, "F"
...
write ""
write ";*********************************************************************"
write ";  End procedure SCX_CPU1_fm_fileinfo_stress                          "
write ";*********************************************************************"
ENDPROC
