...
void Test_FM_ChildProcess_ChildReadIndexGreaterChildQDepth(void)
{
    ...
    FM_GlobalData.ChildQueue[FM_CHILD_QUEUE_DEPTH] = dummy_CC;
    ...
    UtAssert_INT32_EQ(context_CFE_EVS_SendEvent.EventID, FM_CHILD_EXE_ERR_EID);
}
...
void Test_FM_ChildProcess_FMCopyCC(void)
{
    ...
    UtAssert_INT32_EQ(context_CFE_EVS_SendEvent.EventID, FM_COPY_CMD_EID);
}
...
void Test_FM_ChildProcess_FMMoveCC(void)
{
    ...
    UtAssert_INT32_EQ(count_sendevent, 1);
    UtAssert_INT32_EQ(context_CFE_EVS_SendEvent.EventType, CFE_EVS_EventType_DEBUG);
    UtAssert_INT32_EQ(context_CFE_EVS_SendEvent.EventID, FM_MOVE_CMD_EID);
}
...
void Test_FM_ChildProcess_FMRenameCC(void)
{
    ...
    UtAssert_INT32_EQ(count_sendevent, 1);
    UtAssert_INT32_EQ(context_CFE_EVS_SendEvent.EventType, CFE_EVS_EventType_DEBUG);
    UtAssert_INT32_EQ(context_CFE_EVS_SendEvent.EventID, FM_RENAME_CMD_EID);	
}
...
void Test_FM_ChildProcess_FMDeleteCC(void)
{
    ...
    UtAssert_INT32_EQ(count_sendevent, 1);
    UtAssert_INT32_EQ(context_CFE_EVS_SendEvent.EventType, CFE_EVS_EventType_DEBUG);
    UtAssert_INT32_EQ(context_CFE_EVS_SendEvent.EventID, FM_DELETE_CMD_EID);
}
...
void Test_FM_ChildProcess_FMDeleteAllCC(void)
{
    ...
    UtAssert_INT32_EQ(count_sendevent, 1);
    UtAssert_INT32_EQ(context_CFE_EVS_SendEvent.EventType, CFE_EVS_EventType_ERROR);
    UtAssert_INT32_EQ(context_CFE_EVS_SendEvent.EventID, FM_DELETE_ALL_OS_ERR_EID);
}
...
void Test_FM_ChildProcess_FMDecompressCC(void)
{
    ...
    UtAssert_INT32_EQ(count_sendevent, 1);
    UtAssert_INT32_EQ(context_CFE_EVS_SendEvent.EventType, CFE_EVS_EventType_ERROR);
    UtAssert_INT32_EQ(context_CFE_EVS_SendEvent.EventID, FM_DECOM_CFE_ERR_EID);
}
#endif
...
void Test_FM_ChildProcess_FMConcatCC(void)
{
    ...
    UtAssert_INT32_EQ(count_sendevent, 1);
    UtAssert_INT32_EQ(context_CFE_EVS_SendEvent.EventType, CFE_EVS_EventType_ERROR);
    UtAssert_INT32_EQ(context_CFE_EVS_SendEvent.EventID, FM_CONCAT_OSCPY_ERR_EID);
...
void Test_FM_ChildProcess_FMCreateDirCC(void)
{
    ...
    UtAssert_INT32_EQ(count_sendevent, 1);
    UtAssert_INT32_EQ(context_CFE_EVS_SendEvent.EventType, CFE_EVS_EventType_ERROR);
    UtAssert_INT32_EQ(context_CFE_EVS_SendEvent.EventID, FM_CREATE_DIR_OS_ERR_EID);
    UtAssert_INT32_EQ(FM_GlobalData.ChildCurrentCC, 0);
}
...
void Test_FM_ChildProcess_FMDeleteDirCC(void)
{
    ...
    UtAssert_INT32_EQ(count_sendevent, 1);
    UtAssert_INT32_EQ(context_CFE_EVS_SendEvent.EventType, CFE_EVS_EventType_ERROR);
    UtAssert_INT32_EQ(context_CFE_EVS_SendEvent.EventID, FM_DELETE_OPENDIR_OS_ERR_EID);
    UtAssert_INT32_EQ(FM_GlobalData.ChildCurrentCC, 0);
}
...
{
    // Arrange
    FM_ChildQueueEntry_t dummy_CC = {.CommandCode = FM_GET_FILE_INFO_CC,
...
void Test_FM_ChildProcess_FMGetDirListsFileCC(void)
{
    ...
    UtAssert_INT32_EQ(count_sendevent, 1);
    UtAssert_INT32_EQ(context_CFE_EVS_SendEvent.EventType, CFE_EVS_EventType_ERROR);
    UtAssert_INT32_EQ(context_CFE_EVS_SendEvent.EventID, FM_GET_DIR_FILE_OSOPENDIR_ERR_EID);
    UtAssert_INT32_EQ(FM_GlobalData.ChildCurrentCC, 0);
}
...
void Test_FM_ChildProcess_FMGetDirListsPktCC(void)
{
    ...
    UtAssert_INT32_EQ(count_sendevent, 1);
    UtAssert_INT32_EQ(context_CFE_EVS_SendEvent.EventType, CFE_EVS_EventType_DEBUG);
    UtAssert_INT32_EQ(context_CFE_EVS_SendEvent.EventID, FM_GET_DIR_PKT_CMD_EID);
    UtAssert_INT32_EQ(FM_GlobalData.ChildCurrentCC, 0);
    UtAssert_INT32_EQ(childcmdcounter_before + 1, FM_GlobalData.ChildCmdCounter);
}
...
void Test_FM_ChildProcess_FMDeleteIntCC(void)
{
    ...
    UtAssert_INT32_EQ(count_sendevent, 1);
    UtAssert_INT32_EQ(context_CFE_EVS_SendEvent.EventType, CFE_EVS_EventType_ERROR);
    UtAssert_INT32_EQ(context_CFE_EVS_SendEvent.EventID, FM_DELETE_OS_ERR_EID);
    UtAssert_INT32_EQ(childcmderrcounter_before + 1, FM_GlobalData.ChildCmdErrCounter);
    UtAssert_INT32_EQ(FM_GlobalData.ChildCurrentCC, 0);
}
...
void Test_FM_ChildProcess_FMSetFilePermCC(void)
{
    ...
    UtAssert_INT32_EQ(count_sendevent, 1);
    UtAssert_INT32_EQ(context_CFE_EVS_SendEvent.EventType, CFE_EVS_EventType_ERROR);
    UtAssert_INT32_EQ(context_CFE_EVS_SendEvent.EventID, FM_SET_PERM_OS_ERR_EID);
    UtAssert_INT32_EQ(childcmderrcounter_before + 1, FM_GlobalData.ChildCmdErrCounter);
    UtAssert_INT32_EQ(FM_GlobalData.ChildCurrentCC, 0);
}
...
void Test_FM_ChildCopyCmd_OScpIsSuccess(void)
{
    ...
    UtAssert_True(count_childcmdcounter_after == count_childcmdcounter_before +1,
		  "The ChildCmdCounter after is %u and it should be %u",
		  count_childcmdcounter_after, count_childcmdcounter_before +1);
    UtAssert_True(count_childcmderrcounter_after == count_childcmderrcounter_before,
		  "The ChildCmdErrCounter after is %u and it should be %u",
		  count_childcmderrcounter_after, count_childcmderrcounter_before);
    UtAssert_True(count_SendEvent == 1,
		  "SendEvent was called %u time(s) and should be 1",
		  count_SendEvent);
...
void Test_FM_ChildCopyCmd_OScpNotSuccess(void)
{
    ...
    UtAssert_True(count_childcmdcounter_after == count_childcmdcounter_before,
                  "The ChildCmdCounter after is %u and it should be %u",
                  count_childcmdcounter_after, count_childcmdcounter_before);
    UtAssert_True(count_childcmderrcounter_after == count_childcmderrcounter_before+1,
                  "The ChildCmdErrCounter after is %u and it should be %u",
                  count_childcmderrcounter_after, count_childcmderrcounter_before+1);
    UtAssert_True(count_SendEvent == 1,
                  "SendEvent was called %u time(s) and should be 1",
                  count_SendEvent);	
}
...
void Test_FM_ChildMoveCmd_OSmvNotSuccess(void)
{
    ...
    UtAssert_INT32_EQ(count_sendevent, 1);
    UtAssert_INT32_EQ(context_CFE_EVS_SendEvent.EventType, CFE_EVS_EventType_ERROR);
    UtAssert_INT32_EQ(context_CFE_EVS_SendEvent.EventID, FM_MOVE_OS_ERR_EID);
...
void Test_FM_ChildRenameCmd_OSRenameNotSuccess(void)
{
    ...
    UtAssert_INT32_EQ(count_sendevent, 1);
    UtAssert_INT32_EQ(context_CFE_EVS_SendEvent.EventType, CFE_EVS_EventType_ERROR);
    UtAssert_INT32_EQ(context_CFE_EVS_SendEvent.EventID, FM_RENAME_OS_ERR_EID);
    UtAssert_INT32_EQ(count_childcmderrcounter_before + 1, count_childcmderrcounter_after);
    UtAssert_INT32_EQ(count_childcmdcounter_before, count_childcmdcounter_after);
    UtAssert_INT32_EQ(FM_GlobalData.ChildPreviousCC, commandcode_before);
    UtAssert_INT32_EQ(FM_GlobalData.ChildCurrentCC, 0);
...
void Test_FM_ChildDeleteAllCmd_DirReadNotSuccess(void)
{
    ...
    UtAssert_INT32_EQ(count_sendevent, 1);
    UtAssert_INT32_EQ(context_CFE_EVS_SendEvent.EventType, CFE_EVS_EventType_DEBUG);
    UtAssert_INT32_EQ(context_CFE_EVS_SendEvent.EventID, FM_DELETE_ALL_CMD_EID);
    UtAssert_INT32_EQ(FM_GlobalData.ChildPreviousCC, FM_DELETE_ALL_CC);
...
void Test_FM_ChildDecompressCmd_FSDecompressSuccess(void)
{
    ...
    UtAssert_INT32_EQ(count_sendevent, 1);
    UtAssert_INT32_EQ(context_CFE_EVS_SendEvent.EventType, CFE_EVS_EventType_DEBUG);
    UtAssert_INT32_EQ(context_CFE_EVS_SendEvent.EventID, FM_DECOM_CMD_EID);
    UtAssert_INT32_EQ(count_childcmderrcounter_before, count_childcmderrcounter_after);
    UtAssert_INT32_EQ(count_childcmdcounter_before + 1, count_childcmdcounter_after);
    UtAssert_INT32_EQ(FM_GlobalData.ChildPreviousCC, commandcode_before);
    UtAssert_INT32_EQ(FM_GlobalData.ChildCurrentCC, 0);
...
void Test_FM_ChildConcatCmd_OSOpenCreateSourceNotSuccess(void)
{
    ...
    UtAssert_INT32_EQ(count_sendevent, 1);
    UtAssert_INT32_EQ(context_CFE_EVS_SendEvent.EventType, CFE_EVS_EventType_ERROR);
    UtAssert_INT32_EQ(context_CFE_EVS_SendEvent.EventID, FM_CONCAT_OPEN_SRC2_ERR_EID);
    UtAssert_INT32_EQ(FM_GlobalData.ChildCurrentCC, 0);
    UtAssert_INT32_EQ(childcmderrcounter_before + 1, FM_GlobalData.ChildCmdErrCounter);
    UtAssert_INT32_EQ(childcmdcounter_before, FM_GlobalData.ChildCmdCounter);
}
...
void Test_FM_ChildConcatCmd_OSOpenCreateTargetNotSuccess(void)
{
    ...
    UtAssert_INT32_EQ(count_sendevent, 1);
    UtAssert_INT32_EQ(context_CFE_EVS_SendEvent.EventType, CFE_EVS_EventType_ERROR);
    UtAssert_INT32_EQ(context_CFE_EVS_SendEvent.EventID, FM_CONCAT_OPEN_TGT_ERR_EID);
    UtAssert_INT32_EQ(FM_GlobalData.ChildCurrentCC, 0);
    UtAssert_INT32_EQ(childcmderrcounter_before + 1, FM_GlobalData.ChildCmdErrCounter);
    UtAssert_INT32_EQ(childcmdcounter_before, FM_GlobalData.ChildCmdCounter);
}
...
void Test_FM_ChildConcatCmd_OSReadBytesZero(void)
{
    ...
    UtAssert_INT32_EQ(count_sendevent, 1);
    UtAssert_INT32_EQ(context_CFE_EVS_SendEvent.EventType, CFE_EVS_EventType_DEBUG);
    UtAssert_INT32_EQ(context_CFE_EVS_SendEvent.EventID, FM_CONCAT_CMD_EID);
    UtAssert_INT32_EQ(FM_GlobalData.ChildCurrentCC, 0);
    UtAssert_INT32_EQ(childcmderrcounter_before, FM_GlobalData.ChildCmdErrCounter);
    UtAssert_INT32_EQ(childcmdcounter_before + 1, FM_GlobalData.ChildCmdCounter);
}
...
void Test_FM_ChildConcatCmd_OSReadBytesLessThanZero(void)
{
    ...
    UtAssert_INT32_EQ(count_sendevent, 1);
    UtAssert_INT32_EQ(context_CFE_EVS_SendEvent.EventType, CFE_EVS_EventType_ERROR);
    UtAssert_INT32_EQ(context_CFE_EVS_SendEvent.EventID, FM_CONCAT_OSRD_ERR_EID);
    UtAssert_INT32_EQ(FM_GlobalData.ChildCurrentCC, 0);
    UtAssert_INT32_EQ(childcmderrcounter_before + 1, FM_GlobalData.ChildCmdErrCounter);
    UtAssert_INT32_EQ(childcmdcounter_before, FM_GlobalData.ChildCmdCounter);
}
...
void Test_FM_ChildConcatCmd_BytesWrittenNotEqualBytesRead(void)
{
    ...
    UtAssert_INT32_EQ(count_sendevent, 1);
    UtAssert_INT32_EQ(context_CFE_EVS_SendEvent.EventType, CFE_EVS_EventType_ERROR);
    UtAssert_INT32_EQ(context_CFE_EVS_SendEvent.EventID, FM_CONCAT_OSWR_ERR_EID);
    UtAssert_INT32_EQ(FM_GlobalData.ChildCurrentCC, 0);
    UtAssert_INT32_EQ(childcmderrcounter_before + 1, FM_GlobalData.ChildCmdErrCounter);
    UtAssert_INT32_EQ(childcmdcounter_before, FM_GlobalData.ChildCmdCounter);
}
...
void Test_FM_ChildFileInfoCmd_FileInfoCRCEqualIgnoreCRC(void)
{
    ...
    UtAssert_INT32_EQ(count_sendevent, 1);
    UtAssert_INT32_EQ(context_CFE_EVS_SendEvent.EventType, CFE_EVS_EventType_DEBUG);
    UtAssert_INT32_EQ(context_CFE_EVS_SendEvent.EventID, FM_GET_FILE_INFO_CMD_EID);
...
void Test_FM_ChildCreateDirCmd_OSMkDirSuccess(void)
{
    ...
    UtAssert_INT32_EQ(count_sendevent, 1);
    UtAssert_INT32_EQ(context_CFE_EVS_SendEvent.EventType, CFE_EVS_EventType_DEBUG);
    UtAssert_INT32_EQ(context_CFE_EVS_SendEvent.EventID, FM_CREATE_DIR_CMD_EID);
    UtAssert_INT32_EQ(count_childcmderrcounter_before, count_childcmderrcounter_after);
    UtAssert_INT32_EQ(count_childcmdcounter_before + 1, count_childcmdcounter_after);
    UtAssert_INT32_EQ(FM_GlobalData.ChildPreviousCC, commandcode_before);
    UtAssert_INT32_EQ(FM_GlobalData.ChildCurrentCC, 0);
...
void Test_FM_ChildDeleteDirCmd_StrCmpThisDirectoryZero(void)
{
    ...
    UtAssert_INT32_EQ(count_sendevent, 1);
    UtAssert_INT32_EQ(context_CFE_EVS_SendEvent.EventType, CFE_EVS_EventType_ERROR);
    UtAssert_INT32_EQ(context_CFE_EVS_SendEvent.EventID, FM_DELETE_DIR_EMPTY_ERR_EID);
    UtAssert_INT32_EQ(count_childcmderrcounter_before + 1, count_childcmderrcounter_after);
    UtAssert_INT32_EQ(count_childcmdcounter_before, count_childcmdcounter_after);
    UtAssert_INT32_EQ(FM_GlobalData.ChildPreviousCC, commandcode_before);
    UtAssert_INT32_EQ(FM_GlobalData.ChildCurrentCC, 0);
...
void Test_FM_ChildDeleteDirCmd_StrcmpNeitherDirectoryNotZero(void)
{
    ...
    UtAssert_INT32_EQ(count_sendevent, 1);
    UtAssert_INT32_EQ(context_CFE_EVS_SendEvent.EventType, CFE_EVS_EventType_DEBUG);
    UtAssert_INT32_EQ(context_CFE_EVS_SendEvent.EventID, FM_DELETE_DIR_CMD_EID);
    UtAssert_INT32_EQ(count_childcmderrcounter_before, count_childcmderrcounter_after);
    UtAssert_INT32_EQ(count_childcmdcounter_before + 1, count_childcmdcounter_after);
    UtAssert_INT32_EQ(FM_GlobalData.ChildPreviousCC, commandcode_before);
    UtAssert_INT32_EQ(FM_GlobalData.ChildCurrentCC, 0);
...
void Test_FM_ChildDeleteDirCmd_RemoveDirTrueOSRmDirNotSuccess(void)
{
    ...
    UtAssert_INT32_EQ(count_sendevent, 1);
    UtAssert_INT32_EQ(context_CFE_EVS_SendEvent.EventType, CFE_EVS_EventType_ERROR);
    UtAssert_INT32_EQ(context_CFE_EVS_SendEvent.EventID, FM_DELETE_RMDIR_OS_ERR_EID);
    UtAssert_INT32_EQ(count_childcmderrcounter_before + 1, count_childcmderrcounter_after);
    UtAssert_INT32_EQ(count_childcmdcounter_before, count_childcmdcounter_after);
    UtAssert_INT32_EQ(FM_GlobalData.ChildPreviousCC, commandcode_before);
    UtAssert_INT32_EQ(FM_GlobalData.ChildCurrentCC, 0);
...
void Test_FM_ChildDirListFileCmd_ChildDirListFileInitFalse(void)
{
    ...
    UtAssert_INT32_EQ(context_CFE_EVS_SendEvent.EventType, CFE_EVS_EventType_ERROR);
    UtAssert_INT32_EQ(context_CFE_EVS_SendEvent.EventID, FM_GET_DIR_FILE_OSCREAT_ERR_EID);
    UtAssert_INT32_EQ(count_childcmderrcounter_before + 1, count_childcmderrcounter_after);
    UtAssert_INT32_EQ(count_childcmdcounter_before, count_childcmdcounter_after);
    UtAssert_INT32_EQ(FM_GlobalData.ChildPreviousCC, commandcode_before);
    UtAssert_INT32_EQ(FM_GlobalData.ChildCurrentCC, 0);
...
void Test_FM_ChildDirListFileCmd_ChildDirListFileInitTrue(void)
{
    ...
    UtAssert_INT32_EQ(count_osclose, 1);
    UtAssert_INT32_EQ(context_CFE_EVS_SendEvent.EventType, CFE_EVS_EventType_DEBUG);
    UtAssert_INT32_EQ(context_CFE_EVS_SendEvent.EventID, FM_GET_DIR_FILE_CMD_EID);
    UtAssert_INT32_EQ(count_childcmderrcounter_before, count_childcmderrcounter_after);
    UtAssert_INT32_EQ(count_childcmdcounter_before+1, count_childcmdcounter_after);
    UtAssert_INT32_EQ(FM_GlobalData.ChildPreviousCC, commandcode_before);
    UtAssert_INT32_EQ(FM_GlobalData.ChildCurrentCC, 0);
...
void Test_FM_ChildDirListPktCmd_OSDirOpenNotSuccess(void)
{
    ...
    UtAssert_INT32_EQ(count_sendevent, 1);
    UtAssert_INT32_EQ(context_CFE_EVS_SendEvent.EventType, CFE_EVS_EventType_ERROR);
    UtAssert_INT32_EQ(context_CFE_EVS_SendEvent.EventID, FM_GET_DIR_PKT_OS_ERR_EID);
    UtAssert_INT32_EQ(childcmdcounter_before, FM_GlobalData.ChildCmdCounter);
    UtAssert_INT32_EQ(childcmderrcounter_before + 1, FM_GlobalData.ChildCmdErrCounter);
}
...
void Test_FM_ChildDirListPktCmd_PathAndEntryLengthGreaterMaxPathLength(void)
{
    ...
    UT_SetDefaultReturnValue(UT_KEY(OS_DirectoryRead), OS_SUCCESS);
    UT_SetDeferredRetcode(UT_KEY(OS_DirectoryRead), 2, !OS_SUCCESS);
    os_dirent_t dummy_direntry = {.FileName="dummy_direntry_long_"};
    UT_SetDataBuffer(UT_KEY(OS_DirectoryRead), &dummy_direntry, sizeof(dummy_direntry), false);
    FM_DirListEntry_t dummy_listentry = {.EntryName="dummy_filenameshort_ButLong_to_Get_To_64_Blank_Space_Long_String"};
    FM_GlobalData.DirListPkt.TotalFiles = dummy_CC.DirListOffset +1;
    FM_GlobalData.DirListPkt.PacketFiles = FM_DIR_LIST_PKT_ENTRIES - 1;
...
void Test_FM_ChildSetPermissionsCmd_OSChmodSuccess(void)
{
    ...
    UtAssert_INT32_EQ(count_sendevent, 1);
    UtAssert_INT32_EQ(context_CFE_EVS_SendEvent.EventType, CFE_EVS_EventType_DEBUG);
    UtAssert_INT32_EQ(context_CFE_EVS_SendEvent.EventID, FM_SET_PERM_CMD_EID);
    UtAssert_INT32_EQ(count_childcmderrcounter_before, count_childcmderrcounter_after);
    UtAssert_INT32_EQ(count_childcmdcounter_before + 1, count_childcmdcounter_after);
    UtAssert_INT32_EQ(FM_GlobalData.ChildPreviousCC, commandcode_before);
    UtAssert_INT32_EQ(FM_GlobalData.ChildCurrentCC, 0);
...
void Test_FM_ChildDirListFileInit_OSOpenCreateFail(void)
{
    ...
    // Act
    bool result = FM_ChildDirListFileInit(&dummy_filehandleptr, dummy_directory, dummy_filename);
...
void Test_FM_ChildDirListFileInit_FSWriteHeaderNotSameSizeFSHeadert(void)
{
    ...
    UtAssert_INT32_EQ(count_osclose, 1);
    UtAssert_INT32_EQ(context_CFE_EVS_SendEvent.EventType, CFE_EVS_EventType_ERROR);
    UtAssert_INT32_EQ(context_CFE_EVS_SendEvent.EventID, FM_GET_DIR_FILE_WRHDR_ERR_EID);
    UtAssert_INT32_EQ(count_childcmderrcounter_before + 1, count_childcmderrcounter_after);
}
...
void Test_FM_ChildDirListFileInit_OSWriteNotSameSizeDirListFileStatst(void)
{
    ...
    UtAssert_INT32_EQ(count_osclose, 1);
    UtAssert_INT32_EQ(context_CFE_EVS_SendEvent.EventType, CFE_EVS_EventType_ERROR);
    UtAssert_INT32_EQ(context_CFE_EVS_SendEvent.EventID, FM_GET_DIR_FILE_WRBLANK_ERR_EID);
    UtAssert_INT32_EQ(count_childcmderrcounter_before + 1, count_childcmderrcounter_after);
}
...
{
    // Arrange
    uint32 dummy_dirid            = UT_Utils_Any_uint32();
    int32 dummy_filehandle        = UT_Utils_Any_int32();
    const char *dummy_directory   = "dummy_directory";
    const char *dummy_filename    = "dummy_filename";
    ...
    // Act
    FM_ChildDirListFileLoop(dummy_dirid, dummy_filehandle, dummy_directory,
                                          dummy_dirwithstep, dummy_filename, dummy_getsizetimemode);
...
void Test_FM_ChildDirListFileLoop_PathLengthAndEntryLengthGreaterMaxPathLen(void)
{
    ...
    const char *dummy_directory   = "dummy_directory";
    const char *dummy_filename    = "dummy_filename";
    const char *dummy_dirwithstep = "dummy_dirwithstep_length_is_long_too_long_like_really_long_wish_i_knew_how_to_Make_this_easy";
    uint8 dummy_getsizetimemode   = UT_Utils_Any_uint8();
    ...
    FM_GlobalData.ChildCmdWarnCounter = UT_Utils_Any_uint8();
    UT_SetDefaultReturnValue(UT_KEY(OS_DirectoryRead), OS_SUCCESS);
    os_dirent_t dummy_direntry = {.FileName="dummy_directory_name"};
    UT_SetDataBuffer(UT_KEY(OS_DirectoryRead), &dummy_direntry, sizeof(dummy_direntry), false);
    UT_SetDeferredRetcode(UT_KEY(OS_DirectoryRead), 2, !OS_SUCCESS);
...
void Test_FM_ChildDirListFileLoop_FileEntriesGreaterFMDirListFileEntries(void)
{
    ...
    int32 dummy_dirread_number = UT_Utils_Any_int32_BetweenInclusive(FM_DIR_LIST_FILE_ENTRIES+1, 2*FM_DIR_LIST_FILE_ENTRIES);
...
void Test_FM_ChildDirListFileLoop_BytesWrittenNotEqualWriteLength(void)
{
    ...
    UtAssert_INT32_EQ(count_oslseek, 1);
    UtAssert_INT32_EQ(context_CFE_EVS_SendEvent.EventType, CFE_EVS_EventType_ERROR);
    UtAssert_INT32_EQ(context_CFE_EVS_SendEvent.EventID, FM_GET_DIR_FILE_UPSTATS_ERR_EID);
...
void Test_FM_ChildSizeTimeMode_OsStatNoSuccess(void)
{
    ...
    os_fstat_t dummy_filestatus = {.FileModeBits=UT_Utils_Any_uint32(),
                                   .FileTime=dummy_ostime,
                                   .FileSize=UT_Utils_Any_uint32()};
...
void Test_FM_ChildSizeTimeMode_OSFilestateTimeDefined(void)
{
    ...
    os_fstat_t dummy_filestatus = {.FileModeBits=dummy_filemode,
                                   .FileTime=dummy_ostime,
...
void Test_FM_ChildLoop_CountSemTakeNotSuccess(void)
{
    ...
    UtAssert_INT32_EQ(count_sendevent, 1);
    UtAssert_INT32_EQ(FM_CHILD_TERM_SEM_ERR_EID, context_CFE_EVS_SendEvent.EventID);
...
void Test_FM_ChildLoop_ChildQCountEqualZero(void)
{
    ...
    UtAssert_INT32_EQ(count_countsemtake, 1);
    UtAssert_INT32_EQ(count_sendevent, 1);
    UtAssert_INT32_EQ(FM_CHILD_TERM_EMPTYQ_ERR_EID, context_CFE_EVS_SendEvent.EventID);
    UtAssert_INT32_EQ(CFE_EVS_EventType_ERROR, context_CFE_EVS_SendEvent.EventType);
...
void Test_FM_ChildLoop_ChildReadIndexGreaterChildQDepth(void)
{
    ...
    UtAssert_INT32_EQ(count_countsemtake, 1);
    UtAssert_INT32_EQ(count_sendevent, 1);
    UtAssert_INT32_EQ(FM_CHILD_TERM_QIDX_ERR_EID, context_CFE_EVS_SendEvent.EventID);
    UtAssert_INT32_EQ(CFE_EVS_EventType_ERROR, context_CFE_EVS_SendEvent.EventType);
    UtAssert_INT32_EQ(childcmdqcounter_before + 1, FM_GlobalData.ChildCmdErrCounter);
}
...
{
    UtTest_Add(Test_FM_ChildInit_CountSemCreateNotSuccess,
        fm_UT_Setup, fm_UT_TearDown,
        "Test_FM_ChildInit_CountSemCreateNotSuccess");

    UtTest_Add(Test_FM_ChildInit_MutSemCreateNotSuccess,
        fm_UT_Setup, fm_UT_TearDown,
        "Test_FM_ChildInit_MutSemCreateNotSuccess");

    UtTest_Add(Test_FM_ChildInit_MuteSemCreateSuccess_CreateChildTaskNotSuccess,
        fm_UT_Setup, fm_UT_TearDown,
        "Test_FM_ChildInit_MuteSemCreateSuccess_CreateChildTaskNotSuccess");

    UtTest_Add(Test_FM_ChildInit_ReturnSuccess,
	fm_UT_Setup, fm_UT_TearDown,
	"Test_FM_ChildInit_ReturnSuccess");
}

void add_FM_ChildTask_tests(void)
{
    UtTest_Add(Test_FM_ChildTask_ChildLoopCalled,
        fm_UT_Setup, fm_UT_TearDown,
        "FM_ChildTask_ChildLoopCalled");
}

void add_FM_ChildProcess_tests(void)
{
    UtTest_Add(Test_FM_ChildProcess_FMCopyCC,
        fm_UT_Setup, fm_UT_TearDown,
        "Test_FM_ChildProcess_FMCopyCC");

    UtTest_Add(Test_FM_ChildProcess_FMMoveCC,
        fm_UT_Setup, fm_UT_TearDown,
        "Test_FM_ChildProcess_FMMoveCC");

    UtTest_Add(Test_FM_ChildProcess_FMRenameCC,
        fm_UT_Setup, fm_UT_TearDown,
        "Test_FM_ChildProcess_FMRenameCC");

    UtTest_Add(Test_FM_ChildProcess_FMDeleteCC,
        fm_UT_Setup, fm_UT_TearDown,
        "Test_FM_ChildProcess_FMDeleteCC");

    UtTest_Add(Test_FM_ChildProcess_FMDeleteAllCC,
        fm_UT_Setup, fm_UT_TearDown,
        "Test_FM_ChildProcess_FMDeleteAllCC");
#ifdef FM_INCLUDE_DECOMPRESS
    UtTest_Add(Test_FM_ChildProcess_FMDecompressCC,
        fm_UT_Setup, fm_UT_TearDown,
        "Test_FM_ChildProcess_FMDecompressCC");
#endif
    UtTest_Add(Test_FM_ChildProcess_FMConcatCC,
        fm_UT_Setup, fm_UT_TearDown,
        "Test_FM_ChildProcess_FMConcatCC");

    UtTest_Add(Test_FM_ChildProcess_FMCreateDirCC,
        fm_UT_Setup, fm_UT_TearDown,
        "Test_FM_ChildProcess_FMCreateDirCC");

    UtTest_Add(Test_FM_ChildProcess_FMDeleteDirCC,
        fm_UT_Setup, fm_UT_TearDown,
        "Test_FM_ChildProcess_FMDeleteDirCC");

    UtTest_Add(Test_FM_ChildProcess_FMGetFileInfoCC,
        fm_UT_Setup, fm_UT_TearDown,
        "Test_FM_ChildProcess_FMGetFileInfoCC");

    UtTest_Add(Test_FM_ChildProcess_FMGetDirListsFileCC,
        fm_UT_Setup, fm_UT_TearDown,
        "Test_FM_ChildProcess_FMGetDirListsFileCC");

    UtTest_Add(Test_FM_ChildProcess_FMGetDirListsPktCC,
        fm_UT_Setup, fm_UT_TearDown,
        "Test_FM_ChildProcess_FMGetDirListsPktCC");

    UtTest_Add(Test_FM_ChildProcess_FMDeleteIntCC,
        fm_UT_Setup, fm_UT_TearDown,
        "Test_FM_ChildProcess_FMDeleteIntCC");

    UtTest_Add(Test_FM_ChildProcess_FMSetFilePermCC,
        fm_UT_Setup, fm_UT_TearDown,
        "Test_FM_ChildProcess_FMSetFilePermCC");

    UtTest_Add(Test_FM_ChildProcess_DefaultSwitch,
        fm_UT_Setup, fm_UT_TearDown,
        "Test_FM_ChildProcess_DefaultSwitch");

    UtTest_Add(Test_FM_ChildProcess_ChildReadIndexGreaterChildQDepth,
        fm_UT_Setup, fm_UT_TearDown,
...
{
    UtTest_Add(Test_FM_ChildCopyCmd_OScpIsSuccess,
        fm_UT_Setup, fm_UT_TearDown,
        "Test_FM_ChildCopyCmd_OScpIsSuccess");

    UtTest_Add(Test_FM_ChildCopyCmd_OScpNotSuccess,
        fm_UT_Setup, fm_UT_TearDown,
...
{
    UtTest_Add(Test_FM_ChildMoveCmd_OSmvNotSuccess,
        fm_UT_Setup, fm_UT_TearDown,
        "Test_FM_ChildMoveCmd_OSmvNotSuccess");

    UtTest_Add(Test_FM_ChildMoveCmd_OSmvSuccess,
        fm_UT_Setup, fm_UT_TearDown,
        "Test_FM_ChildMoveCmd_OSmvSuccess");
}

void add_FM_ChildRenameCmd_tests(void)
{
    UtTest_Add(Test_FM_ChildRenameCmd_OSRenameNotSuccess,
        fm_UT_Setup, fm_UT_TearDown,
        "Test_FM_ChildRenameCmd_OSRenameNotSuccess");

    UtTest_Add(Test_FM_ChildRenameCmd_OSRenameSuccess,
        fm_UT_Setup, fm_UT_TearDown,
...
{
    UtTest_Add(Test_FM_ChildDeleteCmd_CommandCodeIsDeleteIntCC,
        fm_UT_Setup, fm_UT_TearDown,
        "Test_FM_ChildDeleteCmd_CommandCodeNotDeleteIntCC");

    UtTest_Add(Test_FM_ChildDeleteCmd_OSRenameSuccess,
        fm_UT_Setup, fm_UT_TearDown,
        "Test_FM_ChildDeleteCmd_OSRenameSuccess");

    UtTest_Add(Test_FM_ChildDeleteCmd_OSRenameNotSuccess,
        fm_UT_Setup, fm_UT_TearDown,
...
{
    UtTest_Add(Test_FM_ChildDeleteAllCmd_DirOpenNotSuccess,
        fm_UT_Setup, fm_UT_TearDown,
        "Test_FM_ChildDeleteAllCmd_DirOpenNotSuccess");

    UtTest_Add(Test_FM_ChildDeleteAllCmd_DirReadNotSuccess,
        fm_UT_Setup, fm_UT_TearDown,
        "Test_FM_ChildDeleteAllCmd_DirReadNotSuccess");

    UtTest_Add(Test_FM_ChildDeleteAllCmd_DirEntryThisDirectory,
        fm_UT_Setup, fm_UT_TearDown,
        "Test_FM_ChildDeleteAllCmd_DirEntryThisDirectory");

    UtTest_Add(Test_FM_ChildDeleteAllCmd_DirEntryParentDirectory,
        fm_UT_Setup, fm_UT_TearDown,
        "Test_FM_ChildDeleteAllCmd_DirEntryParentDirectory");

    UtTest_Add(Test_FM_ChildDeleteAllCmd_PathFilenameLengthGreaterMaxPthLen,
        fm_UT_Setup, fm_UT_TearDown,
        "Test_FM_ChildDeleteAllCmd_PathFilenameLengthGreaterMaxPthLen");

    UtTest_Add(Test_FM_ChildDeleteAllCmd_InvalidFilenameState,
        fm_UT_Setup, fm_UT_TearDown,
        "Test_FM_ChildDeleteAllCmd_InvalidFilenameState");

    UtTest_Add(Test_FM_ChildDeleteAllCmd_NotInUseFilenameState,
        fm_UT_Setup, fm_UT_TearDown,
        "Test_FM_ChildDeleteAllCmd_NotInUseFilenameState");

    UtTest_Add(Test_FM_ChildDeleteAllCmd_DirectoryFilenameState,
        fm_UT_Setup, fm_UT_TearDown,
        "Test_FM_ChildDeleteAllCmd_DirectoryFilenameState");

    UtTest_Add(Test_FM_ChildDeleteAllCmd_OpenFilenameState,
        fm_UT_Setup, fm_UT_TearDown,
        "Test_FM_ChildDeleteAllCmd_OpenFilenameState");

    UtTest_Add(Test_FM_ChildDeleteAllCmd_ClosedFilename_OSRmNotSuccess,
        fm_UT_Setup, fm_UT_TearDown,
    ...
    UtTest_Add(Test_FM_ChildDeleteAllCmd_FilenameStateDefaultReturn,
        fm_UT_Setup, fm_UT_TearDown,
...
{
    UtTest_Add(Test_FM_ChildDecompressCmd_FSDecompressNotSuccess,
        fm_UT_Setup, fm_UT_TearDown,
        "Test_FM_ChildDecompressCmd_FSDecompressNotSuccess");

    UtTest_Add(Test_FM_ChildDecompressCmd_FSDecompressSuccess,
        fm_UT_Setup, fm_UT_TearDown,
...
{
    UtTest_Add(Test_FM_ChildConcatCmd_OSCpNotSuccess,
        fm_UT_Setup, fm_UT_TearDown,
        "Test_FM_ChildConcatCmd_OSCpNotSuccess");

    UtTest_Add(Test_FM_ChildConcatCmd_OSOpenCreateSourceNotSuccess,
        fm_UT_Setup, fm_UT_TearDown,
        "Test_FM_ChildConcatCmd_OSOpenCreateSourceNotSuccess");

    UtTest_Add(Test_FM_ChildConcatCmd_OSOpenCreateTargetNotSuccess,
        fm_UT_Setup, fm_UT_TearDown,
        "Test_FM_ChildConcatCmd_OSOpenCreateTargetNotSuccess");

    UtTest_Add(Test_FM_ChildConcatCmd_OSReadBytesZero,
        fm_UT_Setup, fm_UT_TearDown,
        "Test_FM_ChildConcatCmd_OSReadBytesZero");

    UtTest_Add(Test_FM_ChildConcatCmd_OSReadBytesLessThanZero,
        fm_UT_Setup, fm_UT_TearDown,
        "Test_FM_ChildConcatCmd_OSReadBytesLessThanZero");

    UtTest_Add(Test_FM_ChildConcatCmd_BytesWrittenNotEqualBytesRead,
        fm_UT_Setup, fm_UT_TearDown,
        "Test_FM_ChildConcatCmd_BytesWrittenNotEqualBytesRead");

    UtTest_Add(Test_FM_ChildConcatCmd_CopyInProgressTrueLoopCountEqualChildFileLoopCount,
        fm_UT_Setup, fm_UT_TearDown,
...
{
    UtTest_Add(Test_FM_ChildFileInfoCmd_FileInfoCRCEqualIgnoreCRC,
        fm_UT_Setup, fm_UT_TearDown,
        "Test_FM_ChildFileInfoCmd_FileInfoCRCEqualIgnoreCRC");

    UtTest_Add(Test_FM_ChildFileInfoCmd_FileInfoStateIsNotFileClosed,
        fm_UT_Setup, fm_UT_TearDown,
        "Test_FM_ChildFileInfoCmd_FileInfoStateIsNotFileClosed");

    UtTest_Add(Test_FM_ChildFileInfoCmd_FileInfoCRCEqualMission8,
        fm_UT_Setup, fm_UT_TearDown,
        "Test_FM_ChildFileInfoCmd_FileInfoCRCEqualMission8");

    UtTest_Add(Test_FM_ChildFileInfoCmd_FileInfoCRCEqualMission16,
        fm_UT_Setup, fm_UT_TearDown,
        "Test_FM_ChildFileInfoCmd_FileInfoCRCEqualMission16");

    UtTest_Add(Test_FM_ChildFileInfoCmd_FileInfoCRCEqualMission32,
        fm_UT_Setup, fm_UT_TearDown,
        "Test_FM_ChildFileInfoCmd_FileInfoCRCEqualMission32");

    UtTest_Add(Test_FM_ChildFileInfoCmd_FileInfoCRCNotEqualToAnyMissionES,
        fm_UT_Setup, fm_UT_TearDown,
        "Test_FM_ChildFileInfoCmd_FileInfoCRCNotEqualToAnyMissionES");

    UtTest_Add(Test_FM_ChildFileInfoCmd_OSOpenCreateTrueBytesReadZero,
        fm_UT_Setup, fm_UT_TearDown,
        "Test_FM_ChildFileInfoCmd_OSOpenCreateTrueBytesReadZero");

    UtTest_Add(Test_FM_ChildFileInfoCmd_BytesReadLessThanZero,
        fm_UT_Setup, fm_UT_TearDown,
        "Test_FM_ChildFileInfoCmd_BytesReadLessThanZero");

    UtTest_Add(Test_FM_ChildFileInfoCmd_BytesReadGreaterThanZero,
        fm_UT_Setup, fm_UT_TearDown,
...
void add_FM_ChildCreateDirCmd_tests(void)
{
    ...
    UtTest_Add(Test_FM_ChildCreateDirCmd_OSMkDirSuccess,
        fm_UT_Setup, fm_UT_TearDown,
...
void add_FM_ChildDeleteDirCmd_tests(void)
{
    ...
    UtTest_Add(Test_FM_ChildDeleteDirCmd_OSDirectoryOpenNoSuccess,
        fm_UT_Setup, fm_UT_TearDown,
        "Test_FM_ChildDeleteDirCmd_OSDirectoryOpenNoSuccess");
    
    UtTest_Add(Test_FM_ChildDeleteDirCmd_OSDirectoryReadNoSuccess,
        fm_UT_Setup, fm_UT_TearDown,
    ...
    UtTest_Add(Test_FM_ChildDeleteDirCmd_StrCmpParentDirectoryZero,
        fm_UT_Setup, fm_UT_TearDown,
        "Test_FM_ChildDeleteDirCmd_StrCmpParentDirectoryZero");

    UtTest_Add(Test_FM_ChildDeleteDirCmd_StrcmpNeitherDirectoryNotZero,
        fm_UT_Setup, fm_UT_TearDown,
        "Test_FM_ChildDeleteDirCmd_StrcmpNeitherDirectoryNotZero");

    UtTest_Add(Test_FM_ChildDeleteDirCmd_RemoveTheDirIsTrueRmDirSuccess,
        fm_UT_Setup, fm_UT_TearDown,
        "Test_FM_ChildDeleteDirCmd_RemoveTheDirIsTrueRmDirSuccess");   
         
    UtTest_Add(Test_FM_ChildDeleteDirCmd_RemoveDirTrueOSRmDirNotSuccess,
        fm_UT_Setup, fm_UT_TearDown,
...
{
    UtTest_Add(Test_FM_ChildDirListFileCmd_OSDirOpenNotSuccess,
        fm_UT_Setup, fm_UT_TearDown,
        "Test_FM_ChildDirListFileCmd_OSDirOpenNotSuccess");

    UtTest_Add(Test_FM_ChildDirListFileCmd_ChildDirListFileInitFalse,
        fm_UT_Setup, fm_UT_TearDown,
        "Test_FM_ChildDirListFileCmd_ChildDirListFileInitFalse");

    UtTest_Add(Test_FM_ChildDirListFileCmd_ChildDirListFileInitTrue,
        fm_UT_Setup, fm_UT_TearDown,
...
{
    UtTest_Add(Test_FM_ChildDirListPktCmd_OSDirOpenNotSuccess,
        fm_UT_Setup, fm_UT_TearDown,
        "Test_FM_ChildDirListPktCmd_OSDirOpenNotSuccess");

    UtTest_Add(Test_FM_ChildDirListPktCmd_OSDirReadNotSuccess,
        fm_UT_Setup, fm_UT_TearDown,
        "Test_FM_ChildDirListPktCmd_OSDirReadNotSuccess");

    UtTest_Add(Test_FM_ChildDirListPktCmd_DirEntryNameThisDirectory,
        fm_UT_Setup, fm_UT_TearDown,
        "Test_FM_ChildDirListPktCmd_DirEntryNameThisDirectory");

    UtTest_Add(Test_FM_ChildDirListPktCmd_DirEntryNameParentDirectory,
        fm_UT_Setup, fm_UT_TearDown,
        "Test_FM_ChildDirListPktCmd_DirEntryNameParentDirectory");

    UtTest_Add(Test_FM_ChildDirListPktCmd_DirListPktTotalFilesLessThanDirListPktFirstFile,
        fm_UT_Setup, fm_UT_TearDown,
        "Test_FM_ChildDirListPktCmd_DirListPktTotalFilesLessThanDirListPktFirstFile");

    UtTest_Add(Test_FM_ChildDirListPktCmd_DirListPktPacketFilesGreaterDIRListPktEntries,
        fm_UT_Setup, fm_UT_TearDown,
        "Test_FM_ChildDirListPktCmd_DirListPktPacketFilesGreaterDIRListPktEntries");

    UtTest_Add(Test_FM_ChildDirListPktCmd_EntryLengthGreaterListEntryName,
        fm_UT_Setup, fm_UT_TearDown,
        "Test_FM_ChildDirListPktCmd_EntryLengthGreaterListEntryName");

    UtTest_Add(Test_FM_ChildDirListPktCmd_PathAndEntryLengthGreaterMaxPathLength,
        fm_UT_Setup, fm_UT_TearDown,
        "Test_FM_ChildDirListPktCmd_PathAndEntryLengthGreaterMaxPathLength");

    UtTest_Add(Test_FM_ChildDirListPktCmd_EntryLengthAndTotalPathLengthSmallEnough,
        fm_UT_Setup, fm_UT_TearDown,
...
{
    UtTest_Add(Test_FM_ChildSetPermissionsCmd_OSChmodNotSuccess,
        fm_UT_Setup, fm_UT_TearDown,
        "Test_FM_ChildSetPermissionsCmd_OSChmodNotSuccess");

    UtTest_Add(Test_FM_ChildSetPermissionsCmd_OSChmodSuccess,
        fm_UT_Setup, fm_UT_TearDown,
...
{
    UtTest_Add(Test_FM_ChildDirListFileInit_OSOpenCreateFail,
        fm_UT_Setup, fm_UT_TearDown,
        "Test_FM_ChildDirListFileInit_OSOpenCreateFail");

    UtTest_Add(Test_FM_ChildDirListFileInit_FSWriteHeaderNotSameSizeFSHeadert,
        fm_UT_Setup, fm_UT_TearDown,
        "Test_FM_ChildDirListFileInit_FSWriteHeaderNotSameSizeFSHeadert");

    UtTest_Add(Test_FM_ChildDirListFileInit_OSWriteNotSameSizeDirListFileStatst,
        fm_UT_Setup, fm_UT_TearDown,
        "Test_FM_ChildDirListFileInit_OSWriteNotSameSizeDirListFileStatst");   

    UtTest_Add(Test_FM_ChildDirListFileInit_OSWriteSameSizeDirListFileStatst,
        fm_UT_Setup, fm_UT_TearDown,
...
{
    UtTest_Add(Test_FM_ChildDirListFileLoop_OSDirReadNotSuccess,
        fm_UT_Setup, fm_UT_TearDown,
        "Test_FM_ChildDirListFileLoop_OSDirReadNotSuccess");

    UtTest_Add(Test_FM_ChildDirListFileLoop_OSDirEntryNameIsThisDirectory,
        fm_UT_Setup, fm_UT_TearDown,
        "Test_FM_ChildDirListFileLoop_OSDirEntryNameIsThisDirectory");

    UtTest_Add(Test_FM_ChildDirListFileLoop_OSDirEntryNameIsParentDirectory,
        fm_UT_Setup, fm_UT_TearDown,
        "Test_FM_ChildDirListFileLoop_OSDirEntryNameIsParentDirectory");   

    UtTest_Add(Test_FM_ChildDirListFileLoop_PathLengthAndEntryLengthGreaterMaxPathLen,
        fm_UT_Setup, fm_UT_TearDown,
        "Test_FM_ChildDirListFileLoop_PathLengthAndEntryLengthGreaterMaxPathLen");  

    UtTest_Add(Test_FM_ChildDirListFileLoop_FileEntriesGreaterFMDirListFileEntries,
        fm_UT_Setup, fm_UT_TearDown,
        "Test_FM_ChildDirListFileLoop_FileEntriesGreaterFMDirListFileEntries");

    UtTest_Add(Test_FM_ChildDirListFileLoop_BytesWrittenNotEqualWriteLength,
        fm_UT_Setup, fm_UT_TearDown,
        "Test_FM_ChildDirListFileLoop_BytesWrittenNotEqualWriteLength");   

    UtTest_Add(Test_FM_ChildDirListFileLoop_WritelengthEqualToBytesWritten,
        fm_UT_Setup, fm_UT_TearDown,
...
{
    UtTest_Add(Test_FM_ChildSizeTimeMode_OsStatNoSuccess,
        fm_UT_Setup, fm_UT_TearDown,
        "Test_FM_ChildSizeTimeMode_OsStatNoSuccess");

    UtTest_Add(Test_FM_ChildSizeTimeMode_OSFilestateTimeDefined,
        fm_UT_Setup, fm_UT_TearDown,
...
{
    UtTest_Add(Test_FM_ChildLoop_CountSemTakeNotSuccess,
        fm_UT_Setup, fm_UT_TearDown,
        "Test_FM_ChildLoop_CountSemTakeNotSuccess");

    UtTest_Add(Test_FM_ChildLoop_ChildQCountEqualZero,
        fm_UT_Setup, fm_UT_TearDown,
        "Test_FM_ChildLoop_ChildQCountEqualZero");

    UtTest_Add(Test_FM_ChildLoop_ChildReadIndexGreaterChildQDepth,
        fm_UT_Setup, fm_UT_TearDown,
        "Test_FM_ChildLoop_ChildReadIndexGreaterChildQDepth");

    UtTest_Add(Test_FM_ChildLoop_ChildReadIndexEqualChildQDepth,
        fm_UT_Setup, fm_UT_TearDown,
        "Test_FM_ChildLoop_ChildReadIndexEqualChildQDepth");

    UtTest_Add(Test_FM_ChildLoop_CountSemTakeSuccessDefault,
        fm_UT_Setup, fm_UT_TearDown,
